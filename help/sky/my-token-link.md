...
1. Check the boxes under [!UICONTROL Track link for] to choose where you want your links to be tracked.
   ...
   >[!NOTE]
   >
   >If Include mkt_tok is checked, Marketo displays a link preview of the branded tracking domain (e.g., https://mkto-sjqe3355.com/mn/...). If you clear this checkbox, the link is changed. If you turn off link tracking for emails or landing pages, >the URL will be shortened to its basic length (e.g., www.examplepage.com).
