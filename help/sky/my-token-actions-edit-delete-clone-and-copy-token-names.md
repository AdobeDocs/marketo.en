...
>deleted. If you try to delete them, you'll get an error message
>that lists where the token is being used. Remove the token from
>these assets and try deleting it again.
