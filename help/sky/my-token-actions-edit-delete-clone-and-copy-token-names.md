...
>[!NOTE]
>
>Text tokens do not have a separate editor window. Click the [!UICONTROL **Value**] to make in-line edits.
...
1. Right-click the token, then select [!UICONTROL **Delete**].
...
1. To clone a My Token, right-click it and select [!UICONTROL **Clone**].
...
1. Enter a new name for your clone token, make edits if needed, and click [!UICONTROL **Save**].
