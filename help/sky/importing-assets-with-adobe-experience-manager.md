...
1. In Design Studio, select [!UICONTROL **Images and Files**].
...
1. Click the Images and Files drop-down and select [!UICONTROL **Import Image or File**].
...
1. Click the radio button next to Adobe Experience Manager and click [!UICONTROL **Next**].
...
1. Verify the images you've chosen, select the destination folder (Images and Files is the default) and click [!UICONTROL **Next**].
