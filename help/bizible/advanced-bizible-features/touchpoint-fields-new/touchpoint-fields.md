...
##### I don’t see my new Touchpoint Field that I just created in the picklist. Where is it? {#i-don-t-see-my-new-touchpoint-field-that-i-just-created-in-the-picklist-where-is-it}
...
##### What expression do I use to extract multiple parameters from a single landing page? {#what-expression-do-i-use-to-extract-multiple-parameters-from-a-single-landing-page}
...
##### Why don’t I see my new fields in the Bizible schema? {#why-don-t-i-see-my-new-fields-in-the-bizible-schema}
...
##### How can I validate that my extract expression is valid and pulling the correct value? {#how-can-i-validate-that-my-extract-expression-is-valid-and-pulling-the-correct-value}
