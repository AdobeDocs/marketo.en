...
##### Q: How many “boomerang” touchpoints can I have per stage? {#q-how-many-boomerang-touchpoints-can-i-have-per-stage}

You can select up to 10 boomerang touchpoints per stage.

##### Q: Why are we only limited to 10 boomerangs per stage? {#q-why-are-we-only-limited-to-boomerangs-per-stage}
...
##### Q: I have Data Warehouse. Do I get all of the data or does the Boomerang Stages cap apply to me as well? {#q-i-have-data-warehouse-do-i-get-all-of-the-data-or-does-the-boomerang-stages-cap-apply-to-me-as-well}
...
##### Q: What is the benefit of using Boomerang Stages with Custom Modeling? {#q-what-is-the-benefit-of-using-boomerang-stages-with-custom-modeling}
