...
After all of the tasks below are complete, head over to our [User Setup](/help/marketo/getting-started-2/initial-setup/user-setup.md) guide to perform a few foundational steps for your instance's ongoing use.
