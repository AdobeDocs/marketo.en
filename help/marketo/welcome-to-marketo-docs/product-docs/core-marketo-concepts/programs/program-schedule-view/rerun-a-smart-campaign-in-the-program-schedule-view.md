...
Rerun a Smart Campaign in the Program Schedule View - Marketo Docs - Product Documentation
...
1. In the schedule view, click the day you want to set your new run for, and give your entry a name that's easily understood (e.g., "Second Invite").
   ...
   >[!TIP]
   >
   >You can also do this from the [program focus](../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/marketing-calendar/understanding-the-calendar/understand/enable-program-focus.md).
