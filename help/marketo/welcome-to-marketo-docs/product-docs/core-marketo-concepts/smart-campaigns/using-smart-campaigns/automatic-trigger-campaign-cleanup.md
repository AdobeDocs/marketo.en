...
1. Go to the **Notifications** tab.
   ...
   ##### Click Idle Trigger Campaign Cleanup Scheduled. Then click the These Idle Trigger Campaigns will be deactivated link.  {#automatictriggercampaigncleanup-clickidletriggercampaigncleanupscheduled.thenclickthetheseidletriggercampaignswillbedeactivatedlink.}
...
##### 1. Select the Idle Trigger Campaign Cleanup Scheduled notification. Click the These Idle Trigger Campaigns link.  {#automatictriggercampaigncleanup-selecttheidletriggercampaigncleanupschedulednotification.clickthetheseidletriggercampaignslink.}

![](assets/image2015-4-27-20-3a56-3a41.png) 

##### 2. You will see a list of deactivated campaigns. {#automatictriggercampaigncleanup-youwillseealistofdeactivatedcampaigns.}
