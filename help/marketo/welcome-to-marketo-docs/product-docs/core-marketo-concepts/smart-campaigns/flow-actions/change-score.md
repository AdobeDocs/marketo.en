...
Change Score - Marketo Docs - Product Documentation

#### Overview {#changescore-overview}

Scoring people is easy and powerful to help your sales team prioritize.

![](assets/flowstep-changescore.png)

#### Usage {#changescore-usage}
...
1. Pick the score field you want to change.
   ...
   >[!TIP]
   >
   >`You can create multiple score fields. See` [Create a Custom Field in Marketo](../../../../../welcome-to-marketo-docs/product-docs/administration/field-management/create-a-custom-field-in-marketo.md) `for details.`
