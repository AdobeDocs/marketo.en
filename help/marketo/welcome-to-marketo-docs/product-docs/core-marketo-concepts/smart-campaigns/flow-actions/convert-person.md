...
Convert Person - Marketo Docs - Product Documentation
...
#### Overview {#convertperson-overview}
...
1. Select who you want to **assign** the resulting contact, account, and opportunity to.
   ...
   ##### Choose if you want a notification sent to the owner or not. {#convertperson-chooseifyouwantanotificationsenttotheownerornot.}

   ![](assets/three-2.png)

   ##### Select the converted status. {#convertperson-selecttheconvertedstatus.}
