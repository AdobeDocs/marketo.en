...
1. Go to the **Marketing Calendar**.
   ...
   ##### This is a bird's-eye view of assets scheduled in your Marketo instance.  {#navigatingthemarketingcalendar-thisisabird's-eyeviewofassetsscheduledinyourmarketoinstance.}

   ![](assets/image2014-9-15-16-3a44-3a22.png)

#### Change Between Modes {#navigatingthemarketingcalendar-changebetweenmodes}

##### 1. Click the 3 weeks or Month tabs to switch between modes. {#navigatingthemarketingcalendar-clickthe3weeksormonthtabstoswitchbetweenmodes.}
...
1. Click the **Filter drop-down**.
   ...
   ##### Select the Agenda view.  {#navigatingthemarketingcalendar-selecttheagendaview.}
