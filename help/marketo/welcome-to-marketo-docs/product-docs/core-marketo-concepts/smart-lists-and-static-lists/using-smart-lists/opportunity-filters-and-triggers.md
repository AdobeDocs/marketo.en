...
Opportunity filters let you drill into your Salesforce leads who have opportunities. You can find them in the `Opportunities` folder of the `Palette` when editing a s `mart list`. They come in a few flavors.
