...
In this example, let's add some constraints to a ** [Data Value Changed](../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/change-data-value.md)** filter to find people that had a Status change from MQL to SQL.
...
##### 1. Go to Marketing Activities. {#addaconstrainttoasmartlistfilter-gotomarketingactivities.}

![](assets/ma-1.png)

##### 2. Select the smart list with a filter you'll be adding a constraint to, and click the Smart List tab. {#addaconstrainttoasmartlistfilter-selectthesmartlistwithafilteryou'llbeaddingaconstraintto-andclickthesmartlisttab.}
...
1. Enter the **New Value**. In this example we're using SQL.
   ...
   ##### Nicely done! Click the People tab to see all people who had a Status change from MQL to SQL in the past 30 days. {#addaconstrainttoasmartlistfilter-nicelydone!clickthepeopletabtoseeallpeoplewhohadastatuschangefrommqltosqlinthepast30days.}
