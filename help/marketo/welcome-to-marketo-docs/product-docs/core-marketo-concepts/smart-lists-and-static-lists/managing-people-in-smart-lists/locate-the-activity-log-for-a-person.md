...
Locate the Activity Log for a Person - Marketo Docs - Product Documentation
...
##### 1. Go to the Database. {#locatetheactivitylogforaperson-gotothedatabase.}

![](assets/db-2.png)

##### 2. Select All People. {#locatetheactivitylogforaperson-selectallpeople.}

![](assets/two-6.png)

##### 3. Click the People tab. Select a person Id number. {#locatetheactivitylogforaperson-clickthepeopletab.selectapersonidnumber.}

![](assets/three-5.png)

##### 4. Click Activity Log. {#locatetheactivitylogforaperson-clickactivitylog.}
