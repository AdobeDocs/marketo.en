...
`An operator is a part of the [smart list](../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-lists-and-static-lists.md) that helps you get specific. It lets you describe your filter or trigger in straightforward language. The available operators are different for each type of field.`   `  
` Here's a glossary describing each set of operators.

### What's in this article? {#what-s-in-this-article}

[Date Fields](#smartlistfilteroperatorsglossary-datefields)  
[String Fields](#smartlistfilteroperatorsglossary-stringfields)  
[Integer Fields](#smartlistfilteroperatorsglossary-integerfields)
...
| `contains` |Any letters together in the string match (example: cali `for`nia, `for`tune, there `for`) |
...
>[!TIP]
>
>##### Use positive over negative operators. "Is not" filters have to search the entire data set in your instance, which can be extremely time-consuming. Positive "is" filters can leverage more effective search algorithms. {#smartlistfilteroperatorsglossary-usepositiveovernegativeoperators.}>
