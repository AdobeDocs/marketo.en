...
Create a Static List - Marketo Docs - Product Documentation
...
##### 1. Go to Database. {#createastaticlist-gotodatabase.}

![](assets/db.png)

##### 2. Click the New drop-down and select New List. {#createastaticlist-clickthenewdrop-downandselectnewlist.}

![](assets/two.png)

##### 3. Choose a destination folder, give your new list a name, then click Create. {#createastaticlist-chooseadestinationfolder-giveyournewlistaname-thenclickcreate.}
