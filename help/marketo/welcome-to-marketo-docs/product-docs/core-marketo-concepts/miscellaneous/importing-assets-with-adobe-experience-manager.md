...
##### 1. Click Design Studio.  {#importingassetswithadobeexperiencemanager-clickdesignstudio.}

![](assets/one-1.png)

##### 2. Click the New drop-down and select Import from Adobe Experience Manager. {#importingassetswithadobeexperiencemanager-clickthenewdrop-downandselectimportfromadobeexperiencemanager.}

![](assets/two-1.png)

##### 3. Choose the folder where your images will be saved to. {#importingassetswithadobeexperiencemanager-choosethefolderwhereyourimageswillbesavedto.}

![](assets/three-1.png)

##### 4. Log-in to Adobe Experience Manager (if you haven't already). {#importingassetswithadobeexperiencemanager-log-intoadobeexperiencemanager(ifyouhaven'talready).}
...
##### 5. Click Import to complete the process. {#importingassetswithadobeexperiencemanager-clickimporttocompletetheprocess.}
