...
##### 1. Click Admin, and in Database Management, select Marketo Custom Objects. {#addmarketocustomobjectfields-clickadmin-andindatabasemanagement-selectmarketocustomobjects.}

![](assets/image2016-1-18-9-3a2-3a6.png)

##### 2. Select the object you want to add the field to on the right. {#addmarketocustomobjectfields-selecttheobjectyouwanttoaddthefieldtoontheright.}

![](assets/image2016-1-18-9-3a5-3a3.png)

##### 3. In the Fields tab, click New Field. {#addmarketocustomobjectfields-inthefieldstab-clicknewfield.}
...
##### 4. Enter a display name and description. {#addmarketocustomobjectfields-enteradisplaynameanddescription.}
...
##### 5. Now, choose an appropriate data type from the list. {#addmarketocustomobjectfields-now-chooseanappropriatedatatypefromthelist.}

![](assets/image2015-10-5-11-3a37-3a24.png)

##### 6. Pull the Dedupe slider over if you want to use the new field as a unique identifier. Click Save to finish. {#addmarketocustomobjectfields-pullthededupeslideroverifyouwanttousethenewfieldasauniqueidentifier.clicksavetofinish.}
...
##### 7. Add any other fields you need. {#addmarketocustomobjectfields-addanyotherfieldsyouneed.}
