...
##### 1. In Marketo, go to Marketing Activities. {#triggeroffcustomobjectchanges-inmarketo-gotomarketingactivities.}

![](assets/image2016-7-25-15-3a49-3a52.png)

##### 2. Create or open an existing Smart Campaign, and select the Smart List. {#triggeroffcustomobjectchanges-createoropenanexistingsmartcampaign-andselectthesmartlist.}

![](assets/image2016-7-25-16-3a9-3a19.png)

##### 3. Search for the trigger you need and drag it onto the canvas. {#triggeroffcustomobjectchanges-searchforthetriggeryouneedanddragitontothecanvas.}

![](assets/image2016-7-25-16-3a16-3a43.png)

##### 4. Select the trigger attribute. {#triggeroffcustomobjectchanges-selectthetriggerattribute.}

![](assets/image2016-7-25-16-3a21-3a42.png)

##### 5. Optionally, set a constraint. {#triggeroffcustomobjectchanges-optionally-setaconstraint.}

![](assets/image2016-9-6-14-3a25-3a22.png)

##### 6. And there you are. The change is automatically saved. {#triggeroffcustomobjectchanges-andthereyouare.thechangeisautomaticallysaved.}
