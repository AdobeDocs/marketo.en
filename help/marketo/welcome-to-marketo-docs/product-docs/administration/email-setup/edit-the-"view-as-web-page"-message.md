...
If you need to edit the " [View as a Webpage](../../../../welcome-to-marketo-docs/product-docs/email-marketing/general/functions-in-the-editor/add-a-view-as-web-page-link-to-an-email.md) `"` text, here's how.
...
[Edit the "View as Web Page" Message](#editthe"viewaswebpage"message-editthe"viewaswebpage"message)  
[Default "View as Web Page" Text](#editthe"viewaswebpage"message-default"viewaswebpage"text)
...
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div style="text-align: center"><font face="Verdana" size="1">To view this email as a web page, <a href="%mkt_webview_url%?mkt_tok=##MKT_TOK##">click here</a></font></div></pre>` **View as Web Page Text:**

To view this email as a web page, go to the following address:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence">%mkt_webview_url%?mkt_tok=##MKT_TOK##</pre>` Boom! You're done.
