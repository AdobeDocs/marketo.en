...
##### 1. Go to Admin and click Users & Roles. {#enableno-draftforsnippets-gotoadminandclickusers&roles.}

![](assets/usersandroles.png)

##### 2. Go to the Roles tab, select a role, then click Edit Role. {#enableno-draftforsnippets-gototherolestab-selectarole-thenclickeditrole.}

![](assets/editrole2.png)

##### 3. Expand the Access Design Studio option. {#enableno-draftforsnippets-expandtheaccessdesignstudiooption.}

![](assets/expanddesignstudio.png)

##### 4. Expand the Access Snippet option. {#enableno-draftforsnippets-expandtheaccesssnippetoption.}

![](assets/expandsnippet.png)

##### 5. Expand the Approve Snippet permission and check the No-Draft box. Then click Save. {#enableno-draftforsnippets-expandtheapprovesnippetpermissionandchecktheno-draftbox.thenclicksave.}
