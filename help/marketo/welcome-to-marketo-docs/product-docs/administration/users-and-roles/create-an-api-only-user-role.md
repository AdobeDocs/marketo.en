...
If you want to integrate with Marketo via the [REST API](http://developers.marketo.com/documentation/rest/), the best practice is to [assign a user the API Only role](create-an-api-only-user.md) and then [create a custom service for use with ReST API](../../../../welcome-to-marketo-docs/product-docs/administration/additional-integrations/create-a-custom-service-for-use-with-rest-api.md). Here's how to create the API only user role.

>[!NOTE]
>
>**Admin Permissions Required**

##### 1. From My Marketo, click Admin. {#createanapionlyuserrole-frommymarketo-clickadmin.}

![](assets/adminhand-1.png)

##### 2. Under Security, click Users & Roles. {#createanapionlyuserrole-undersecurity-clickusers&roles.}
