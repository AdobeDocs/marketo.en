...
##### 1. Go to Admin and click Field Management. {#blockfieldupdatesduringlistimportfromuntrustedsources-gotoadminandclickfieldmanagement.}

![](assets/image2014-9-19-9-3a38-3a38.png)

##### 2. Find the field you want, select it, then under Field Actions, click Block Field Updates. {#blockfieldupdatesduringlistimportfromuntrustedsources-findthefieldyouwant-selectit-thenunderfieldactions-clickblockfieldupdates.}

![](assets/image2014-9-19-9-3a39-3a40.png)

##### 3. Check List Import untrusted source and click Apply. {#blockfieldupdatesduringlistimportfromuntrustedsources-checklistimportuntrustedsourceandclickapply.}
