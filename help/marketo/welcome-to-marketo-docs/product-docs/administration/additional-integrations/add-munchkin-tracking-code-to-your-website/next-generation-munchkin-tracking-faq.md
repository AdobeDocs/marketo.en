...
#### When will my Marketo subscription be on Munchkin V2? {#nextgenerationmunchkintrackingfaq-whenwillmymarketosubscriptionbeonmunchkinv2?}

We don't have an exact date yet, but please check back here for updates.&nbsp;

#### Will I need to make any changes to my Munchkin tracking on my website? {#nextgenerationmunchkintrackingfaq-willineedtomakeanychangestomymunchkintrackingonmywebsite?}
...
#### Why did Marketo remove the “Is Anonymous” filter from Smart Lists? {#nextgenerationmunchkintrackingfaq-whydidmarketoremovethe“isanonymous”filterfromsmartlists?}
...
#### What happens to my Smart Lists that already have the “Is Anonymous” filter? {#nextgenerationmunchkintrackingfaq-whathappenstomysmartliststhatalreadyhavethe“isanonymous”filter?}
...
#### I've been using Marketo for a while. How do I know which of my campaigns use the “Is Anonymous” filter? {#nextgenerationmunchkintrackingfaq-i'vebeenusingmarketoforawhile.howdoiknowwhichofmycampaignsusethe“isanonymous”filter?}
...
#### I'd like more detailed documentation. Where can I find it? {#nextgenerationmunchkintrackingfaq-i'dlikemoredetaileddocumentation.wherecanifindit?}
...
#### I have more questions! How do I get them answered? {#nextgenerationmunchkintrackingfaq-ihavemorequestions!howdoigetthemanswered?}

Please reach out on the  [community](https://nation.marketo.com/welcome). You can also send an email to [ `[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#4734323737283533072a26352c2233286924282a69)&nbsp;They'll&nbsp;be happy to answer your questions.
