...
>[!NOTE]
>
>To learn more about Workspace best practices, please contact [Marketo Professional Services](http://docs.marketo.com/cdn-cgi/l/email-protection#e89b8d9a9e818b8d9ba885899a838d9c87c68b8785).
...
1. Enter a** Name**, and select the **Person Partition(s)** you want to use. ` Choose a **Primary Person Partition**.`
   ...
   ##### If you enabled multiple branded domains, you must choose a primary branded domain. {#createanewworkspace-ifyouenabledmultiplebrandeddomains-youmustchooseaprimarybrandeddomain.}

   ![](assets/four-1.png)

   ##### Select the workspace language. {#createanewworkspace-selecttheworkspacelanguage.}
   ...
   ##### Click Create. {#createanewworkspace-clickcreate.}
