...
[Workspaces](#understandingworkspacesandpersonpartitions-workspaces)  
[Sharing across Workspaces](#understandingworkspacesandpersonpartitions-sharingacrossworkspaces)  
[Cloning across Workspaces](#understandingworkspacesandpersonpartitions-cloningacrossworkspaces)  
[Moving Assets to other Workspaces](#understandingworkspacesandpersonpartitions-movingassetstootherworkspaces)  
[Person Partitions](#understandingworkspacesandpersonpartitions-personpartitions)
...
{#understandingworkspacesandpersonpartitions-sharingacrossworkspaces}
...
##### 1. Create a new folder. {#understandingworkspacesandpersonpartitions-createanewfolder.}

![](assets/one.png)

##### 2. Name the folder you're going to share. {#understandingworkspacesandpersonpartitions-namethefolderyou'regoingtoshare.}

![](assets/two.png)

##### 3. Move the asset(s) you want to share into the folder. {#understandingworkspacesandpersonpartitions-movetheasset(s)youwanttoshareintothefolder.}

![](assets/three.png)

##### 4. Right-click the folder and select Share Folder. {#understandingworkspacesandpersonpartitions-right-clickthefolderandselectsharefolder.}

![](assets/four.png)

##### 5. Select the workspace(s) you want to share the folder with and click Save. The Share Folder dialog box will only display workspaces you have permission to view. {#understandingworkspacesandpersonpartitions-selecttheworkspace(s)youwanttosharethefolderwithandclicksave.thesharefolderdialogboxwillonlydisplayworkspacesyouhavepermissiontoview.}
...
* Models
* Smart campaigns
* [Smart lists](../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/reference-a-list-or-smart-list-across-workspaces.md)
