...
SEO - Add/Remove an Inbound Link URL From a List - Marketo Docs - Product Documentation

You can organize your inbound link URLs to your heart's content.

### What's in this article? {#what-s-in-this-article}

[Add an Inbound Link URL to a List](#seo-add/removeaninboundlinkurlfromalist-addaninboundlinkurltoalist)  
[Remove an Inbound Link URL from a List](#seo-add/removeaninboundlinkurlfromalist-removeaninboundlinkurlfromalist)
...
>[!TIP]
>
>##### You can also make a new list for your keyword to go. Just type your desired name in Create a new list. {#seo-add/removeaninboundlinkurlfromalist-youcanalsomakeanewlistforyourkeywordtogo.justtypeyourdesirednameincreateanewlist.}>

#### Remove an Inbound Link URL from a List {#seo-add/removeaninboundlinkurlfromalist-removeaninboundlinkurlfromalist}

##### 1. Sometimes you'll want to remove an inbound link URL's from a list. {#seo-add/removeaninboundlinkurlfromalist-sometimesyou'llwanttoremoveaninboundlinkurl'sfromalist.}
