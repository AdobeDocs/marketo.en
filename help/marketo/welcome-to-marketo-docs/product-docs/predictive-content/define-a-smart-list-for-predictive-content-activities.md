...
1. Click the **Name** drop-down and select an operator.
   ...
   ##### Define the trigger. {#defineasmartlistforpredictivecontentactivities-definethetrigger.}

   ![](assets/smart-lislt-select-content-hands.png)

   ##### Add the Type constraint. {#defineasmartlistforpredictivecontentactivities-addthetypeconstraint.}

   ![](assets/clicks-predictive-content-add-constraint-hands.png)

   ##### Select the source you need for your smart list. {#defineasmartlistforpredictivecontentactivities-selectthesourceyouneedforyoursmartlist.}

   ![](assets/pc-add-constraint.png)

   ##### If you're using the email source for your predictive content, add the Clicks Link in Email trigger. Select your email and add the Is Predictive constraint, defined as true. {#defineasmartlistforpredictivecontentactivities-ifyou'reusingtheemailsourceforyourpredictivecontent-addtheclickslinkinemailtrigger.selectyouremailandaddtheispredictiveconstraint-definedastrue.}

   ![](assets/clicks-link-in-email-trigger-hands.png)

   ##### Add any other filters as needed. {#defineasmartlistforpredictivecontentactivities-addanyotherfiltersasneeded.}
