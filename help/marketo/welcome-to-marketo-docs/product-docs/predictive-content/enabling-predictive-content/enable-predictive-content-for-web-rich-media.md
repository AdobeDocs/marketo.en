...
Enable Predictive Content for Web Rich Media - Marketo Docs - Product Documentation
...
##### 1. To enable an individual title, click a title to open the editor. Click Rich Media, then check the Enabled for Predictive Content in Rich Media box and click Save. {#enablepredictivecontentforwebrichmedia-toenableanindividualtitle-clickatitletoopentheeditor.clickrichmedia-thenchecktheenabledforpredictivecontentinrichmediaboxandclicksave.}

![](assets/image2017-10-3-9-3a50-3a29.png)

##### 2. For multiple pieces of content, on the Predictive Content page, check the boxes next to the title(s).  {#enablepredictivecontentforwebrichmedia-formultiplepiecesofcontent-onthepredictivecontentpage-checktheboxesnexttothetitle(s).}

![](assets/image2017-10-3-10-3a0-3a42.png)

##### 3. Click the Content Actions drop-down and select Enable for Web Rich Media. {#enablepredictivecontentforwebrichmedia-clickthecontentactionsdrop-downandselectenableforwebrichmedia.}

` ![](assets/image2017-10-3-10-3a2-3a6.png)|`

#### Customize the Javascript Code and Embed it into your Website {#enablepredictivecontentforwebrichmedia-customizethejavascriptcodeandembeditintoyourwebsite}
