...
Define Segment Rules - Marketo Docs - Product Documentation
...
1. Fill appropriate values for the filters.
   ...
   >
   >
   >Smart Lists are awesome. Learn all you can do with [Smart Lists and Static Lists](../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-lists-and-static-lists.md).
...
1. Go to **Segmentation Actions**. Click **Approve**.
   ...
   >
   >
   >If you get an error message during approval and require assistance in reducing the complexity of your segmentation, please contact [Marketo Support](http://docs.marketo.com/cdn-cgi/l/email-protection#82f1f7f2f2edf0f6c2efe3f0e9e7f6edace1edef).
