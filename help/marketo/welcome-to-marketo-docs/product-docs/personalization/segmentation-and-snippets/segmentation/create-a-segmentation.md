...
##### 1. Go to Database. {#createasegmentation-gotodatabase.}
...
1. `Click`**New ** `and then`**New Segmentation** `.`
   ...
   ##### Enter a Name, click on Add Segment and name it.  {#createasegmentation-enteraname-clickonaddsegmentandnameit.}
   ...
   ##### Add as many segments as you want (up to 100). {#createasegmentation-addasmanysegmentsasyouwant(upto100).}
   ...
   >
   >
   >If you get an error message during approval and require assistance in reducing the complexity of your segmentation, please contact [Marketo Support](http://docs.marketo.com/cdn-cgi/l/email-protection#3d4e484d4d524f497d505c4f56584952135e5250).
