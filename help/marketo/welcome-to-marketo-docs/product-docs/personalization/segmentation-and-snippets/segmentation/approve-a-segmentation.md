...
Approve a Segmentation - Marketo Docs - Product Documentation
...
1. Go to the **Database**.
   ...
   ##### In the Segmentation click Segmentation Actions, and then Approve. {#approveasegmentation-inthesegmentationclicksegmentationactions-andthenapprove.}
...
>
>If you get an error message during approval and require assistance in reducing the complexity of your segmentation, please contact [Marketo Support](http://docs.marketo.com/cdn-cgi/l/email-protection#f784828787988583b79a96859c928398d994989a).
