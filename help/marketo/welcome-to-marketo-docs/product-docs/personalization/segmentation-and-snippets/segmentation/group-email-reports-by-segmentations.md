...
`Segmentations are not just for Dynamic Content. You can group your` [email performance report](../../../../../welcome-to-marketo-docs/product-docs/email-marketing/email-programs/email-program-data/email-performance-report.md) `by` [segmentations](../../../../../welcome-to-marketo-docs/product-docs/personalization/segmentation-and-snippets.md) `, too.`
