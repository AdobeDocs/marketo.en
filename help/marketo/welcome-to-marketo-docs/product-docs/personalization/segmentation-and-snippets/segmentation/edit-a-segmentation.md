...
[Create a Segmentation Draft](#editasegmentation-createasegmentationdraft)  
[Add, Edit, or Delete Segments](#editasegmentation-add-edit-ordeletesegments)  
[Edit Segment Rules](#editasegmentation-editsegmentrules)
...
1. Go to the **Database**.
   ...
   ##### In your Segmentation, click on Segmentation Actions and then Create Draft. {#editasegmentation-inyoursegmentation-clickonsegmentationactionsandthencreatedraft.}
