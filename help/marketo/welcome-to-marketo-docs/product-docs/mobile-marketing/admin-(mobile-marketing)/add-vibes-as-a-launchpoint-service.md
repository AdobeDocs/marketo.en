...
##### 1. In My Marketo, click Admin and then LaunchPoint. {#addvibesasalaunchpointservice-inmymarketo-clickadminandthenlaunchpoint.}

![](assets/image2016-7-27-9-3a31-3a17.png)

##### 2. Click New and New Service. {#addvibesasalaunchpointservice-clicknewandnewservice.}

![](assets/image2016-7-27-9-3a34-3a25.png)

##### 3. Enter a display name and in the drop-down, select Vibes. {#addvibesasalaunchpointservice-enteradisplaynameandinthedrop-down-selectvibes.}

![](assets/new-service-vibes.png)

##### 4. Under Settings, enter your Vibes username, password, and API Company Key. Click Create. {#addvibesasalaunchpointservice-undersettings-enteryourvibesusername-password-andapicompanykey.clickcreate.}
