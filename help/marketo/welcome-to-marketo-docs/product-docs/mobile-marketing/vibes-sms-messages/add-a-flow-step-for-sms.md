...
##### 1. In My Marketo, click Marketing Activities. {#addaflowstepforsms-inmymarketo-clickmarketingactivities.}

![](assets/image2016-7-28-11-3a41-3a17.png)

##### 2. Find the smart campaign you want to add the SMS flow to. Click the Flow tab. {#addaflowstepforsms-findthesmartcampaignyouwanttoaddthesmsflowto.clicktheflowtab.}

![](assets/image2016-7-28-11-3a43-3a41.png)

##### 3. Drag over the flow, for example, Send SMS Message. Select the SMS Message and the Vibes list from the drop-downs. {#addaflowstepforsms-dragovertheflow-forexample-sendsmsmessage.selectthesmsmessageandthevibeslistfromthedrop-downs.}
