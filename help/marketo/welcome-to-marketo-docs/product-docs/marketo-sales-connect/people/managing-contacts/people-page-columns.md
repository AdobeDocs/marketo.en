...
[How to Select Columns](#peoplepagecolumns-howtoselectcolumns)  
[Column Descriptions](#peoplepagecolumns-columndescriptions)

#### How to Select Columns {#peoplepagecolumns-howtoselectcolumns}

##### 1. In the People page, click the List Settings icon. {#peoplepagecolumns-inthepeoplepage-clickthelistsettingsicon.}

![](assets/one-4.png)

##### 2. Scroll through and select your desired columns (you can also click Select All if you want every column). Click out of the list when done. {#peoplepagecolumns-scrollthroughandselectyourdesiredcolumns(youcanalsoclickselectallifyouwanteverycolumn).clickoutofthelistwhendone.}
