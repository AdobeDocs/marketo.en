...
##### 1. Navigate to the [web application](http://toutapp.com/login). {#sharecallrecordingswithyourteam-navigatetothewebapplication.}

##### 2. Open up the person details. {#sharecallrecordingswithyourteam-openupthepersondetails.}

##### 3. Find the Call Activity under the activity list. {#sharecallrecordingswithyourteam-findthecallactivityundertheactivitylist.}

##### 4. Right-click on the call recording and copy the link URL. {#sharecallrecordingswithyourteam-right-clickonthecallrecordingandcopythelinkurl.}
...
##### 1. Navigate to the task created in Salesforce for the call. {#sharecallrecordingswithyourteam-navigatetothetaskcreatedinsalesforceforthecall.}

##### 2. Copy the link listed in the Sales Call Recording field. {#sharecallrecordingswithyourteam-copythelinklistedinthesalescallrecordingfield.}
