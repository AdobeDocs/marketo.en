...
##### 1. Navigate to the Analytics page. {#templateengagement-navigatetotheanalyticspage.}

##### 2. Click the Content button and filter by the desired date range. {#templateengagement-clickthecontentbuttonandfilterbythedesireddaterange.}

##### 3. Based on the selected date range, at the top of the page you can see the total number of emails and templates used across your team. {#templateengagement-basedontheselecteddaterange-atthetopofthepageyoucanseethetotalnumberofemailsandtemplatesusedacrossyourteam.}
