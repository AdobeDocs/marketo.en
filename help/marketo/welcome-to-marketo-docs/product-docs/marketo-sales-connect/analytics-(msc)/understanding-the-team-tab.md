...
Understanding the Team Tab - Marketo Docs - Product Documentation

In the Team Tab we highlight three&nbsp;important metrics.

#### Emails sent with template {#understandingtheteamtab-emailssentwithtemplate}

Of the emails that have been sent, how many of them utilized a template.

#### Peak time of engagement {#understandingtheteamtab-peaktimeofengagement}
...
#### Deals closed {#understandingtheteamtab-dealsclosed}
