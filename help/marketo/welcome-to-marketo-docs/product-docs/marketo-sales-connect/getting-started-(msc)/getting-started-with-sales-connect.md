...
##### 1. In Marketo, click Admin. {#gettingstartedwithsalesconnect-inmarketo-clickadmin.}

![](assets/one.png)

##### 2. In the tree, click Sales Connect. {#gettingstartedwithsalesconnect-inthetree-clicksalesconnect.}

![](assets/two.png)

##### 3. Select and send the following Marketo credentials to your Sales Connect Admin: Munchkin ID, Client ID, Client Secret. {#gettingstartedwithsalesconnect-selectandsendthefollowingmarketocredentialstoyoursalesconnectadmin-munchkinid-clientid-clientsecret.}
...
##### 1. In Sales Connect, click the gear icon and select Settings. {#gettingstartedwithsalesconnect-insalesconnect-clickthegeariconandselectsettings.}

![](assets/four.png)

##### 2. Under Admin Settings, select Marketo. {#gettingstartedwithsalesconnect-underadminsettings-selectmarketo.}

![](assets/eight.png)

##### 3. Input the Marketo credentials provided by the Marketo Admin and click Connect. {#gettingstartedwithsalesconnect-inputthemarketocredentialsprovidedbythemarketoadminandclickconnect.}
...
##### 1. Select one or more users, then click Connect. {#gettingstartedwithsalesconnect-selectoneormoreusers-thenclickconnect.}
...
##### 2. If your Marketo subscription has workspaces enabled, you'll be able to assign workspaces to each user or set of users in bulk. If no workspaces are selected, we’ll assign them to the Default Marketo workspace. {#gettingstartedwithsalesconnect-ifyourmarketosubscriptionhasworkspacesenabled-you'llbeabletoassignworkspacestoeachuserorsetofusersinbulk.ifnoworkspacesareselected-we’llassignthemtothedefaultmarketoworkspace.}

![](assets/nine.jpg)

##### 3. Click the Workspace drop-down, select your desired workspace(s), and click Connect. {#gettingstartedwithsalesconnect-clicktheworkspacedrop-down-selectyourdesiredworkspace(s)-andclickconnect.}
