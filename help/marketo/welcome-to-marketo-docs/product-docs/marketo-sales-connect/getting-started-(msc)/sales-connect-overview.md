...
<table class="wrapped confluenceTable"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1"><p>Lead received a call from a salesperson using the <a href="http://docs.marketo.com/x/NgDb" class="external-link" rel="nofollow">Sales Phone</a>.</p></td> 
  </tr> 
  <tr> 
