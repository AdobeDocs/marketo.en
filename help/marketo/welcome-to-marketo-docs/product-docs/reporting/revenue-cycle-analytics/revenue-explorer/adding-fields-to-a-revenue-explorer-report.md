...
Adding Fields to a Revenue Explorer Report - Marketo Docs - Product Documentation
...
##### 1. Find the yellow field(s) you want to use and drag it into Rows. {#addingfieldstoarevenueexplorerreport-findtheyellowfield(s)youwanttouseanddragitintorows.}
...
##### 2. Find the blue field(s) you want to use and drag it into Measures. {#addingfieldstoarevenueexplorerreport-findthebluefield(s)youwanttouseanddragitintomeasures.}
