...
#### Overview {#understandingtheprogramopportunityanalysisarea-overview}
...
#### Program Opportunity Analysis Attribution Measures (Blue Dots) {#understandingtheprogramopportunityanalysisarea-programopportunityanalysisattributionmeasures(bluedots)}
...
#### Acquisition and Success-Related Measures {#understandingtheprogramopportunityanalysisarea-acquisitionandsuccess-relatedmeasures}
...
<table class="confluenceTable"> 
 <tbody> 
  ...
  <tr> 
   <td><span>Pipeline Created</span></td> 
...
#### Miscellaneous Program-Related Measures {#understandingtheprogramopportunityanalysisarea-miscellaneousprogram-relatedmeasures}
...
<table class="confluenceTable"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><span>The average number of Program successes before the Opportunity was closed. <br></span></td> 
  </tr> 
  <tr> 
...
#### Program Opportunity Analysis Dimensions (Yellow Dots) {#understandingtheprogramopportunityanalysisarea-programopportunityanalysisdimensions(yellowdots)}
...
>](../../../../../welcome-to-marketo-docs/product-docs/reporting/revenue-cycle-analytics/revenue-explorer/create-a-revenue-explorer-report.md)
