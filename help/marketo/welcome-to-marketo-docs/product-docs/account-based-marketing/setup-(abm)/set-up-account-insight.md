...
##### 1. Click Admin. {#setupaccountinsight-clickadmin.}

![](assets/admin-1.png)

##### 2. Click ABM in the tree, then the ABM Sales tab. {#setupaccountinsight-clickabminthetree-thentheabmsalestab.}

![](assets/two-5.png)

##### 3. Click Edit. {#setupaccountinsight-clickedit.}

![](assets/three-4.png)

##### 4. Click the drop-downs to choose how Account Insight prioritizes named accounts and engaged people. {#setupaccountinsight-clickthedrop-downstochoosehowaccountinsightprioritizesnamedaccountsandengagedpeople.}
...
##### 5. Click Save. {#setupaccountinsight-clicksave.}
