...
Export a List with Personalized URLs - Marketo Docs - Product Documentation
...
1. Select your list or smart list, click on the **Leads** tab to get the results and then click on the excel icon. `INLINE Make sure you have`**Marketo Unique Code ** `and`**Marketo Unique Name** [columns visible](../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/create-and-change-views-for-lists-and-smart-list.md) `.`
