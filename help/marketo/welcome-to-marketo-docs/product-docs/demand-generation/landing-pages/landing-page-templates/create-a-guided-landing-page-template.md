...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoImg" id="exampleImg" mktoName="Example    Image"></div></pre>` 
...
**id**: ID string. Contains only letters, numbers, dash "-", and underscore "_". No spaces allowed. Must be unique.  
**mktoName**&nbsp;: String. This is the display name that will be shown in the landing page editor. Best practice is to use a descriptive name.
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoForm" id="exampleForm" mktoName="Example Form"></div></pre>` 

#### Snippet {#createaguidedlandingpagetemplate-snippet}
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoSnippet" id="exampleSnippet" mktoName="Example Snippet"></div></pre>` 
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoShareButton" id="exampleShareButton" mktoName="Example Share Button"></div></pre>` 
...
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoVideo" id="exampleVideo" mktoName="Example Video"></div></pre>` **Poll**
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoPoll" id="examplePoll" mktoName="Example Poll"></div></pre>` 
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoReferral" id="exampleReferral" mktoName="Example Referral"></div></pre>` 
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoSweepstakes" id="exampleSweepstakes" mktoName="Example Sweepstakes"></div></pre>` 
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence">${var1}</pre>` **Declaration:**
...
Basic Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoString" id="var1" mktoName="My Variable"></pre>` Example with all attributes:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoString" id="var1" mktoName="My Variable" default="This is my default value" allowHtml="true"></pre>` 

#### Color {#createaguidedlandingpagetemplate-color}
...
Basic Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoColor" id="color1" mktoName="My Color Variable"></pre>` Example with all attributes:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoColor" id="color" mktoName="My Color Variable" default="#336699"></pre>` 
...
Basic Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoColor" id="color" mktoName="My Color Variable" default="#336699"></pre>`     `<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoBoolean" id="boolean1" mktoName="My Boolean Variable"></pre>` Example with all attributes:
...
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoBoolean" id="boolean1" mktoName="My Boolean Variable" default="true" true_value="block" false_value="none" false_value_name="Hide" true_value_name="Show"><style>  #myConditionalDisplayArea {    display: ${boolean1};  }</style></pre>` 
