...
# Change a Form's Locale {#change-a-form-s-locale}

Change a Form's Locale - Marketo Docs - Product Documentation
...
##### 1. Go to Marketing Activities. {#changeaform'slocale-gotomarketingactivities.}
