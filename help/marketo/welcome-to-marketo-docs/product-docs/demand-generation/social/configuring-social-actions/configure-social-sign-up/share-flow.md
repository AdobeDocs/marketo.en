...
`When you create a` [social app](../../../../../../welcome-to-marketo-docs/product-docs/demand-generation/social.md) `, you can configure the social network choices and prompts that a user encounters as they sign up.`

### What's in this article? {#what-s-in-this-article}

[Select Networks for Sharing](#configuresocialsign-up/shareflow-selectnetworksforsharing)  
[Configure the Facebook Message](#configuresocialsign-up/shareflow-configurethefacebookmessage)  
[Configure the Twitter Message](#configuresocialsign-up/shareflow-configurethetwittermessage)  
[Configure the LinkedIn Message](#configuresocialsign-up/shareflow-configurethelinkedinmessage)
...
1. If you chose **Add Static** **content** above, edit the title, caption, and description, and upload a custom image (from your [**Marketo Images** **and** **Files**](../../../../../../welcome-to-marketo-docs/product-docs/demand-generation/images-and-files/add-images-and-files-to-marketo.md)**).**
...
1. Edit the share prompt and message that will appear in Twitter tweets. 
   ...
   ##### Click Next. {#configuresocialsign-up/shareflow-clicknext..1}
...
1. If you chose **Add Static** **content** above, edit the title and description, and upload a custom image (from your [**Marketo Images** **and** **Files**](../../../../../../welcome-to-marketo-docs/product-docs/demand-generation/images-and-files/add-images-and-files-to-marketo.md)).
...
>**Related Articles**
>
>Next, you can click **Finish > Approve and Close** and put your social app on a landing page. You can also configure [person capture](../../../../../../welcome-to-marketo-docs/product-docs/demand-generation/social/configuring-social-actions/configure-person-capture-for-a-social-app.md) or the [re-share prompt](../../../../../../welcome-to-marketo-docs/product-docs/demand-generation/social/configuring-social-actions/configure-re-share-email-and-prompt-for-a-social-app.md).
