...
Create an Event with GotoWebinar - Marketo Docs - Product Documentation
...
### Title and Description {#createaneventwithgotowebinar-titleanddescription}
...
### Date & Time {#createaneventwithgotowebinar-date&time}
...
##### 1. Select an event. Click Event Actions and choose Event Settings. {#createaneventwithgotowebinar-selectanevent.clickeventactionsandchooseeventsettings.}
...
##### 2. Choose GoToWebinar from the Event Partner List. {#createaneventwithgotowebinar-choosegotowebinarfromtheeventpartnerlist.}

![](assets/image2015-5-14-14-3a55-3a20.png)

##### 3. Choose the account. {#createaneventwithgotowebinar-choosetheaccount.}

![](assets/rtaimage-2.png)

##### 4. Select the webinar. {#createaneventwithgotowebinar-selectthewebinar.}

![](assets/image2015-5-14-14-3a57-3a31.png)

##### 5. Click Save. {#createaneventwithgotowebinar-clicksave.}

![](assets/image2015-5-14-14-3a58-3a54.png)

##### 6. Excellent! Now the event is synced and scheduled by GoToWebinar. {#createaneventwithgotowebinar-excellent!nowtheeventissyncedandscheduledbygotowebinar.}
...
#### Viewing the Schedule  {#createaneventwithgotowebinar-viewingtheschedule}
