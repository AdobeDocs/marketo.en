...
Create an Event with WebEx - Marketo Docs - Product Documentation
...
First create a Webex Event in the WebEx Event Center. `Marketo only uses specific settings and fields for your integration, which we’ll go through shortly. Other fields that you might want to configure for WebEx are explained in the` [WebEx Event Center guide.](http://wlc.webex.com/learnObj/EC/EN/EC_EN_T29-257/EC_EN_T29-257.htm) 

###  Basic Information {#createaneventwithwebex-basicinformation}
...
### Date & Time {#createaneventwithwebex-date&time}
...
### Audio Conference Settings {#createaneventwithwebex-audioconferencesettings}
...
### Event Description & Options {#createaneventwithwebex-eventdescription&options}
...
### Attendees & Registration {#createaneventwithwebex-attendees&registration}
...
### Presenters & Panelists {#createaneventwithwebex-presenters&panelists}

The information configured in this section is not passed to Marketo.

### Email Messages {#createaneventwithwebex-emailmessages}
...
##### 1. Select the event you created. Open the Event Actions drop-down. Choose Event Settings. {#createaneventwithwebex-selecttheeventyoucreated.opentheeventactionsdrop-down.chooseeventsettings.}
...
##### 2. Under Event Partner, select WebEx. {#createaneventwithwebex-undereventpartner-selectwebex.}

![](assets/image2015-1-30-13-3a58-3a2.png)

##### 3. Under Login, choose your WebEx login. {#createaneventwithwebex-underlogin-chooseyourwebexlogin.}

![](assets/image2015-5-18-12-3a2-3a26.png)

##### 4. Under Event, choose your freshly created WebEx event. Then, select an optional Back-up Page and click Save. {#createaneventwithwebex-underevent-chooseyourfreshlycreatedwebexevent.then-selectanoptionalback-uppageandclicksave.}

![](assets/image2015-5-14-16-3a15-3a55.png)

##### 5. Select an optional Back-up Page for your WebEx event. Choose from the drop-down of approved Marketo landing pages or enter the URL of a non-Marketo landing page. {#createaneventwithwebex-selectanoptionalback-uppageforyourwebexevent.choosefromthedrop-downofapprovedmarketolandingpagesorentertheurlofanon-marketolandingpage.}
...
People who sign up for your webinar will get pushed to your webinar provider via the Change Program Status flow step when the New Status is set to "Registered." No other status will push the person over. Also, be sure to make Change Program Status flow step #1, and Send Email flow step #2.   ![](assets/webex.png)
...
#### Viewing the Schedule  {#createaneventwithwebex-viewingtheschedule}
