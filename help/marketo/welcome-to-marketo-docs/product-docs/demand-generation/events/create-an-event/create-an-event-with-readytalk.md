...
Create an Event with ReadyTalk - Marketo Docs - Product Documentation
...
##### 1. Select your event, then click Event Actions, and finally Event Settings. {#createaneventwithreadytalk-selectyourevent-thenclickeventactions-andfinallyeventsettings.}
...
##### 2. Under Event Partner, select ReadyTalk. {#createaneventwithreadytalk-undereventpartner-selectreadytalk.}

** ![](assets/image2015-5-18-12-3a47-3a59.png)

**

##### 3. Under Login, select your ReadyTalk login. {#createaneventwithreadytalk-underlogin-selectyourreadytalklogin.}

** ![](assets/image2015-5-18-12-3a48-3a48.png)

**

##### 4. Under Event, select the event you want to link then click Save. {#createaneventwithreadytalk-underevent-selecttheeventyouwanttolinkthenclicksave.}
...
People who sign up for your webinar will get pushed to your webinar provider via the Change Program Status flow step when the New Status is set to "Registered." No other status will push the person over. Also, be sure to make Change Program Status flow step #1, and Send Email flow step #2.   ![](assets/readytalk.png)
...
#### Viewing the Schedule  {#createaneventwithreadytalk-viewingtheschedule}
