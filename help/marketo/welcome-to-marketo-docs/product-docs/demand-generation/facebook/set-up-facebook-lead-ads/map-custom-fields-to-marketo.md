...
##### 1. Go to the Admin area and click LaunchPoint. Under Installed Services, find and edit Facebook Lead Ads. {#mapcustomfieldstomarketo-gototheadminareaandclicklaunchpoint.underinstalledservices-findandeditfacebookleadads.}

![](assets/image2017-10-24-9-3a32-3a16.png)

##### 2.  Click Next. {#mapcustomfieldstomarketo-clicknext.}

![](assets/image2017-10-24-14-3a55-3a13.png)

##### 3. Leave the authorized account as is—do not make any changes. Click Next. {#mapcustomfieldstomarketo-leavetheauthorizedaccountasis—donotmakeanychanges.clicknext.}

![](assets/image2017-10-24-14-3a56-3a48.png)

##### 4. As before, leave the selected pages as is—do not make any changes. Click Next. {#mapcustomfieldstomarketo-asbefore-leavetheselectedpagesasis—donotmakeanychanges.clicknext.}

![](assets/image2017-10-24-15-3a0-3a54.png)

##### 5. Here's where you map the custom Facebook field to your Marketo field. Click Add. {#mapcustomfieldstomarketo-here'swhereyoumapthecustomfacebookfieldtoyourmarketofield.clickadd.}

** ![](assets/image2017-10-24-9-3a33-3a49.png)

**

##### 6. In the new row, enter the name of your Facebook custom field. {#mapcustomfieldstomarketo-inthenewrow-enterthenameofyourfacebookcustomfield.}
...
##### 7. Click in the Marketo Field column. Type to search for the field you want to map to. Once you've selected a field, click Save. {#mapcustomfieldstomarketo-clickinthemarketofieldcolumn.typetosearchforthefieldyouwanttomapto.onceyou'veselectedafield-clicksave.}
