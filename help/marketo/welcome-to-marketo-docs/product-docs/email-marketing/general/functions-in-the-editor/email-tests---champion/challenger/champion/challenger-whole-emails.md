...
##### 1. In the email test editor, select Whole Emails in the Test Type dropdown. {#champion/challenger-wholeemails-intheemailtesteditor-selectwholeemailsinthetesttypedropdown.}
...
##### 2. Find and select the Challengers email(s), then click Clone. {#champion/challenger-wholeemails-findandselectthechallengersemail(s)-thenclickclone.}
...
1. Click **Next**.
   ...
   ##### Progress! Let's keep on it. {#champion/challenger-wholeemails-progress!let'skeeponit.}
