...
##### 2. Select the Calendar File token and click Insert. {#includeacalendarevent(.ics)inanemail-selectthecalendarfiletokenandclickinsert.}

![](assets/image2014-9-11-16-3a53-3a30.png)  

##### 3. Click Save. {#includeacalendarevent(.ics)inanemail-clicksave.}

![](assets/three-5.png)

##### 4. Your recipients will receive an email that looks like this. {#includeacalendarevent(.ics)inanemail-yourrecipientswillreceiveanemailthatlookslikethis.}
