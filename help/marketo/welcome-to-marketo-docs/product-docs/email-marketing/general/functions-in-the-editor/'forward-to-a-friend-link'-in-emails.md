...
'Forward to a Friend Link' in Emails - Marketo Docs - Product Documentation
...
[Add the Link to an Email Template](#id-'forwardtoafriendlink'inemails-addthelinktoanemailtemplate)  
[Add the Link to an Individual Email](#id-'forwardtoafriendlink'inemails-addthelinktoanindividualemail)  
[View Forwarding Activity](#id-'forwardtoafriendlink'inemails-viewforwardingactivity)  
[Trigger or Filter using Forwarding Activity](#id-'forwardtoafriendlink'inemails-triggerorfilterusingforwardingactivity)  
[Test Forward to Friend](#id-'forwardtoafriendlink'inemails-testforwardtofriend)
...
1. Paste the following HTML code where you want the 'Forward to Friend' link to appear (if you need help with this part, please confer with your web developer):
   ...
   `<pre class="syntaxhighlighter-pre" data-theme="Confluence"><a href="{{system.forwardToFriendLink}}">Forward to Friend</a></pre>`  
   ![](assets/three-7.png)
...
1. Open the email you want to include the link in, and double-click in the editable area.
   ...
   ##### Put the cursor where you want the link to appear and click the Insert Token button. {#id-'forwardtoafriendlink'inemails-putthecursorwhereyouwantthelinktoappearandclicktheinserttokenbutton.}
...
1. To view a person by ID, copy and paste the** Person ID** to the end of the URL (the beginning of said URL will depend on your Marketo instance):
   ...
   `<pre class="syntaxhighlighter-pre" data-theme="Confluence">...marketo.com/Database/loadPersonDetail?personId=</pre>`
