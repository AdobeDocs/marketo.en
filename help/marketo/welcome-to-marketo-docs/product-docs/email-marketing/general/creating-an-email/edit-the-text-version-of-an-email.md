...
Edit the Text Version of an Email - Marketo Docs - Product Documentation
...
##### 1. In the email editor, click the Text tab at the bottom of the email. {#editthetextversionofanemail-intheemaileditor-clickthetexttabatthebottomoftheemail.}

![](assets/one-5.png)

##### 2. Uncheck Automatically copy from HTML to make changes. {#editthetextversionofanemail-uncheckautomaticallycopyfromhtmltomakechanges.}

![](assets/two-5.png)

##### 3. Double-click the text area. {#editthetextversionofanemail-double-clickthetextarea.}

![](assets/three-4.png)

##### 4. Make your edits. After you're done simply close the editor, or go back to the HTML version. The changes will auto-save. {#editthetextversionofanemail-makeyouredits.afteryou'redonesimplyclosetheeditor-orgobacktothehtmlversion.thechangeswillauto-save.}
