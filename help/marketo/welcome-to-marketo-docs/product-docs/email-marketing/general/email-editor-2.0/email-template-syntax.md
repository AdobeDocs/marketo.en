...
[Elements](#emailtemplatesyntax-elements)  
[Variables](#emailtemplatesyntax-variables)  
[Modules](#emailtemplatesyntax-modules)  
[Containers](#emailtemplatesyntax-containers)
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktEditable" id="exampleText" mktoName="Main Body Text">Optionally add default text for the editable text area.</div></pre>` 

###### Option 2 - mktoText {#emailtemplatesyntax-option2-mktotext}
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoText" id="exampleText" mktoName="Main Body Text">Optionally add default text for the editable text area.</div></pre>` 

## Images {#emailtemplatesyntax-images}
...
###### Option 1 – Use a <div> {#emailtemplatesyntax-option1–usea<div>}
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoImg" id="exampleImg" mktoName="Example Image" mktoImgLink="http://www.marketo.com">    <a><img style="border:10px solid red;"></a></div></pre>` 

###### Option 2 – Use an <img> {#emailtemplatesyntax-option2–usean<img>}
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><img class="mktoImg" id="exampleImg" mktoName="Example Image"></pre>` 

## Snippets {#emailtemplatesyntax-snippets}

`If you define a region as a Snippet, end users will be able to choose which approved [Snippet](../../../../../welcome-to-marketo-docs/product-docs/email-marketing/general/functions-in-the-editor/add-a-snippet-to-an-email.md)they'd like to insert in this region` `. Although` `Rich Text elements can be converted into Snippets from within the email editor, when you define a region specifically as a Snippet it cannot be converted to Rich Text.`You can specify a Snippet region using a <div> with class=”mktoSnippet”
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoSnippet" id="unsubscribeFooter" mktoName="Unsubscribe Footer" mktoDefaultSnippetId="12"></div></pre>` 

## Video {#emailtemplatesyntax-video}
...
Example:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><div class="mktoVideo" id="productVideo" mktoName="Product Announcement Video"></div></pre>` 
...
## String {#emailtemplatesyntax-string}
...
Example Declaration:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoString" id="textHeader" mktoName="Text Header" default="Edit Me"></pre>` Example Usage:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence">${textHeader}</pre>` 

## List {#emailtemplatesyntax-list}
...
Example Declaration:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoList" id="textFontFamily" mktoName="Main Text Font Family" values="Arial,Verdana,Times New Roman"></pre>` Example Usage:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence">${textFontFamily}</pre>` 

## Number {#emailtemplatesyntax-number}
...
Example Declaration:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoNumber" id="textFontSize" mktoName="Main Text Font Size" default="12" min="8" max="18" units="px" step="1"> </pre>` Example Usage:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence">${textFontSize}</pre>` 

## Color {#emailtemplatesyntax-color}
...
Example Declaration:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoColor" id="textColor" mktoName="Main Text Color" default="#FFFFFF"></pre>` Example Usage:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence">${textColor}</pre>` 

## Boolean {#emailtemplatesyntax-boolean}
...
Example Declaration:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoBoolean" id="showFooter" mktoName="Show Footer BG?" default="false" false_value="transparent" true_value="black" false_value_name="NO" true_value_name="YES"></pre>` Example Usage:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence">${showFooter}</pre>` 

## HTML Block {#emailtemplatesyntax-htmlblock}
...
Example Declaration:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoHTML" id="trackingPixel" mktoName="Add Tracking Pixel"></pre>` Example Usage:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence">${trackingPixel}</pre>` 

## Image Variable {#emailtemplatesyntax-imagevariable}
...
Example Declaration:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence"><meta class="mktoImg" id="heroBackgroundImage" mktoName="Hero Background Image" default="http://www.company.com/image.jpg"></pre>` Example Usage:
`<pre class="syntaxhighlighter-pre" data-theme="Confluence">${heroBackgroundImage}</pre>` 
