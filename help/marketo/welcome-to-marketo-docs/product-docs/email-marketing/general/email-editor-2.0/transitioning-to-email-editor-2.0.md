...
Transitioning to Email Editor 2.0 - Marketo Docs - Product Documentation

As of the [June '19 release](../../../../../welcome-to-marketo-docs/release-notes/2016/release-notes-spring-'16.md), all Marketo subscriptions have been transitioned to Email Editor 2.0. [Learn more](https://nation.marketo.com/docs/DOC-7038) about the Email Editor 1.0 deprecation.
...
##### By default, all of your existing emails and email templates will be marked as v1.0 if they were created either prior to the Spring ’16 Release, or after the release when Email Editor 2.0 is disabled. With Email Editor 2.0 now automatically enabled, you will see the following behavior: {#transitioningtoemaileditor2.0-bydefault-allofyourexistingemailsandemailtemplateswillbemarkedasv1.0iftheywerecreatedeitherpriortothespring’16release-orafterthereleasewhenemaileditor2.0isdisabled.withemaileditor2.0nowautomaticallyenabled-youwillseethefollow}
...
##### If your subscription has v1.0 emails before the move to Email Editor 2.0, you will experience the following behavior based on the asset's current state: {#transitioningtoemaileditor2.0-ifyoursubscriptionhasv1.0emailsbeforethemovetoemaileditor2.0-youwillexperiencethefollowingbehaviorbasedontheasset'scurrentstate-}
...
##### If your subscription has v1.0 email templates before the move to Email Editor 2.0, you will experience the following behavior: {#transitioningtoemaileditor2.0-ifyoursubscriptionhasv1.0emailtemplatesbeforethemovetoemaileditor2.0-youwillexperiencethefollowingbehavior-}
...
##### If you approve an email template that was previously v1.0 (in any of the above states), you will see the following behavior: {#transitioningtoemaileditor2.0-ifyouapproveanemailtemplatethatwaspreviouslyv1.0(inanyoftheabovestates)-youwillseethefollowingbehavior-}
...
##### Things to Note {#transitioningtoemaileditor2.0-thingstonote}
