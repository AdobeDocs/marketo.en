...
1. Use the slider to choose what percentage of the audience you want in your A/B test and click **Next**.
   ...
   OK, we're almost there. Now we need to [define the A/B test winner criteria](../../../../../../../../welcome-to-marketo-docs/product-docs/email-marketing/email-programs/email-program-actions/email-test---a/b-test/define-the-a/b-test-winner-criteria.md). 
