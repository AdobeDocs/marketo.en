...
When [adding an A/B test](../../../../../../../../welcome-to-marketo-docs/product-docs/email-marketing/email-programs/email-program-actions/email-test---a/b-test/add-an-a/b-test.md) to your email program, you will need to pick a test type, [schedule the A/B test](../../../../../../../../welcome-to-marketo-docs/product-docs/email-marketing/email-programs/email-program-actions/email-test---a/b-test/schedule-the-a/b-test.md), then define the winner criteria. Here's how to decide which email wins.
