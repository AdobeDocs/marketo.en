...
1. And then the time.
   ...
   ##### You can also choose to use the [Recipient Time Zone](scheduling-with-recipient-time-zone/schedule-email-programs-with-recipient-time-zone.md) and/or [Head Start](head-start-for-email-programs.md) features. {#scheduleyouremailprogram-youcanalsochoosetousetherecipienttimezoneand/orheadstartfeatures.}
