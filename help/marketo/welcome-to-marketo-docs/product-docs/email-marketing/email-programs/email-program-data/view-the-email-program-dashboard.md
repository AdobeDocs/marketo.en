...
View the Email Program Dashboard - Marketo Docs - Product Documentation

Check out how your email program (with or without an A/B test) is performing with this dashboard.

#### Select your Email Program {#viewtheemailprogramdashboard-selectyouremailprogram}
...
1. Find and select your email program.
   ...
   #### Email Program A/B Test View {#viewtheemailprogramdashboard-emailprograma/btestview}
   ...
   #### Email Program View {#viewtheemailprogramdashboard-emailprogramview}
