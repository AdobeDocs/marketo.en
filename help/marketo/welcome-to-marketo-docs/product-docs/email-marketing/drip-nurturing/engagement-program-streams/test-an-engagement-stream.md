...
1. Select your person from the **Test Person **drop-down. Remember, content will actually go out, so keep that in mind when choosing.
   ...
   ##### After the person goes through the [transition rules](transition-people-between-engagement-streams.md) you previously set up, click the Refresh icon. {#testanengagementstream-afterthepersongoesthroughthetransitionrulesyoupreviouslysetup-clicktherefreshicon.}

   ![](assets/six-rubiks.png)

   ##### The new stream will appear, indicating a successful test. {#testanengagementstream-thenewstreamwillappear-indicatingasuccessfultest.}
