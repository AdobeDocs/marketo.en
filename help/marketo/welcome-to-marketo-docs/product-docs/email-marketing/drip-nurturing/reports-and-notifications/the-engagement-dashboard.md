...
The Engagement Dashboard is the easiest way to see how the content in your [engagement programs](../../../../../welcome-to-marketo-docs/product-docs/email-marketing/drip-nurturing.md) is performing.

### What's in this article? {#what-s-in-this-article}

[View the Engagement Dashboard](#theengagementdashboard-viewtheengagementdashboard)  
[Understand the Exhaustion Widget](#theengagementdashboard-understandtheexhaustionwidget)  
[Understand the Engagement Over Time Widget](#theengagementdashboard-understandtheengagementovertimewidget)  
[Understand the Highest Engagement Widget](#theengagementdashboard-understandthehighestengagementwidget)
...
To show a single piece of content instead of an average, `c` `lick the gear icon, then select the piece of content.`
...
>**Deep Dive**
>
>`Learn more in the` [Create an Engagement Program](../../../../../welcome-to-marketo-docs/product-docs/email-marketing/drip-nurturing/creating-an-engagement-program/create-an-engagement-program.md) `deep dive.`
