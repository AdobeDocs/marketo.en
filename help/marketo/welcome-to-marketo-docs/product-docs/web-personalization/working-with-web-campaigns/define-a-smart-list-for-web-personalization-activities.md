...
1. Define the trigger.
   ...
   ##### Add filters as needed. {#defineasmartlistforwebpersonalizationactivities-addfiltersasneeded.}
   ...
   `To run the campaign on a set of people all at the same time, learn how to` [Define Smart List for Smart Campaign | Batch](../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/define-smart-list-for-smart-campaign-|-batch.md)
