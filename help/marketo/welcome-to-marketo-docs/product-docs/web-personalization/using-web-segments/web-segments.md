...
Web Segments - Marketo Docs - Product Documentation

### What's in this article? {#what-s-in-this-article}

[View Segment](#websegments-viewsegment)  
[Enable or Disable a Segment](#websegments-enableordisableasegment)  
[Create Segments](#websegments-createsegments)  
[Edit Segments](#websegments-editsegments)  
[Delete Segments](#websegments-deletesegments)
...
<table class="confluenceTable"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1" rowspan="1"><span>The title of the segment</span></td> 
  </tr> 
  <tr> 
   <td colspan="1" rowspan="1"><p><strong>Matches</strong></p></td> 
   <td colspan="1" rowspan="1"><span>The number of visitors meeting the customized, defined criteria of the segment</span></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1" rowspan="1"><span>Displays a table of the visitor's activity and URL path on the site and how long they visited each page </span></td> 
  </tr> 
 </tbody> 
</table>
...
### Firmographics {#websegments-firmographics}
...
Select from a [Named Account List](../../../../welcome-to-marketo-docs/product-docs/web-personalization/account-based-web-marketing/create-a-new-account-list.md) to segment key targeted accounts
...
### Known People {#websegments-knownpeople}
...
### Behavioral {#websegments-behavioral}
...
*
    ...
    *
        ...
        * `UR`L does not match – Add the URL of specific web pages you wish to exclude from tracking. You can add multiple URLs by separating them with a semicolon

![](assets/segment-extra.png)

### Device / Browser {#websegments-device/browser}
