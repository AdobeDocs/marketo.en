...
Web Personalization Overview - Marketo Docs - Product Documentation

### What's in this article? {#what-s-in-this-article}

[Introduction](#webpersonalizationoverview-introduction)  
[Organizations](#webpersonalizationoverview-organizations)  
[Visitors](#webpersonalizationoverview-visitors)  
[Real-Time](#webpersonalizationoverview-real-time)
...
<table class="confluenceTable"> 
 <tbody> 
  <tr> 
   ...
   <td><img class="confluence-embedded-image" src="assets/image2014-11-10-19-3a22-3a47.png" data-linked-resource-id="5046291" data-linked-resource-type="attachment" data-base-url="https://docs.marketo.com" data-linked-resource-container-id="3571900"></td> 
  </tr> 
 </tbody> 
</table>
...
Want to share the information of your website visitor to a colleague? C `lick on an Organization and then click on the Share link on the right-hand side panel.`
...
<table class="confluenceTable"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1"><span>Displays the visitor's country, state and city</span></td> 
  </tr> 
  <tr> 
...
<table class="confluenceTable"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1" rowspan="1"><span> Represents the number of visitors currently on your website</span></td> 
  </tr> 
  <tr> 
   <td colspan="1" rowspan="1"><p><strong>Clicks per minute</strong></p></td> 
   <td colspan="1" rowspan="1"> <span>A live line graph showing the number of clicks on your site per minute</span></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1"><span>The number of visitors currently onsite that match designated segments</span></td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>Currently Browsing</strong></td> 
   <td colspan="1"><span>The URL of the pages currently being viewed by onsite visitors</span></td> 
  </tr> 
  <tr> 
   <td colspan="1" rowspan="1"><strong>Top Referrals</strong></td> 
   <td colspan="1" rowspan="1"><span>The referral URL that brought the visitor to your site</span></td> 
  </tr> 
 </tbody> 
</table>
