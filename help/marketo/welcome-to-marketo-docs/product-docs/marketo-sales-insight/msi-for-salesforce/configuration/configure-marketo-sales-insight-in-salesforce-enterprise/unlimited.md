...
>**Prerequisites**
>
>* [Configure Marketo field sync in your Salesforce Enterprise/Unlimited Edition](../../../../../../welcome-to-marketo-docs/product-docs/crm-sync/salesforce-sync/setup/enterprise/unlimited-edition.md)
...
[Configure Marketo Sales Insight](#configuremarketosalesinsightinsalesforceenterprise/unlimited-configuremarketosalesinsight)  
[Customize Page Layouts](#configuremarketosalesinsightinsalesforceenterprise/unlimited-customizepagelayouts)  
[Map Custom Lead Fields](#configuremarketosalesinsightinsalesforceenterprise/unlimited-mapcustomleadfields)  
[Access Marketo Sales Insight](#configuremarketosalesinsightinsalesforceenterprise/unlimited-accessmarketosalesinsight)
...
1. Go to the **Admin** area. Select **Sales Insight**.
   ...
   ##### Click on Edit API Configuration. {#configuremarketosalesinsightinsalesforceenterprise/unlimited-clickoneditapiconfiguration.}
...
1. When finished, click **Save**.
   ...
   ##### Repeat steps 7-9 to add Visualforce page sections for Contact, Account, and Opportunity. Then repeat steps 10-12 to add Sales Insight fields for Contact. This is presuming you've already done both for Lead. {#configuremarketosalesinsightinsalesforceenterprise/unlimited-repeatsteps7-9toaddvisualforcepagesectionsforcontact-account-andopportunity.thenrepeatsteps10-12toaddsalesinsightfieldsforcontact.thisispresumingyou'vealreadydonebothforlead.}

#### Map Custom Lead Fields {#configuremarketosalesinsightinsalesforceenterprise/unlimited-mapcustomleadfields}

Marketo lead fields need to be mapped to Salesforce contact fields to ensure no data gets lost during conversions.

##### 1. Click Setup. {#configuremarketosalesinsightinsalesforceenterprise/unlimited-clicksetup..1}

![](assets/image2015-6-12-16-3a38-3a34.png)

##### 2. Search for "fields" in the search bar and click Fields under Leads. {#configuremarketosalesinsightinsalesforceenterprise/unlimited-searchfor"fields"inthesearchbarandclickfieldsunderleads.}

![](assets/image2015-6-1-9-3a54-3a50.png)

##### 3. Click Map Lead Fields. {#configuremarketosalesinsightinsalesforceenterprise/unlimited-clickmapleadfields.}

![](assets/map-lead-fields.png)

##### 4. Click on the dropdown on the right for Engagement. {#configuremarketosalesinsightinsalesforceenterprise/unlimited-clickonthedropdownontherightforengagement.}

![](assets/image2015-6-1-10-3a9-3a53.png)

##### 5. Select Contact.Engagement in the list. {#configuremarketosalesinsightinsalesforceenterprise/unlimited-selectcontact.engagementinthelist.}

![](assets/image2015-6-1-10-3a12-3a11.png)

##### 6. Repeat and map these fields as well. {#configuremarketosalesinsightinsalesforceenterprise/unlimited-repeatandmapthesefieldsaswell.}
