...
MSI Feature Overview - Marketo Docs - Product Documentation

MSI has the following features available in Salesforce Lightning and Classic.

### What's in this article? {#what-s-in-this-article}

[Visualforce Panel](#msifeatureoverview-visualforcepanel)  
[Lead Layout](#msifeatureoverview-leadlayout)  
[Contact Layout](#msifeatureoverview-contactlayout)  
[Account Layout](#msifeatureoverview-accountlayout)  
[Opportunity Layout](#msifeatureoverview-opportunitylayout)  
[Lead and Contact List view (Bulk Actions)](#msifeatureoverview-leadandcontactlistview(bulkactions))  
[Marketo Tab](#msifeatureoverview-marketotab)  
[Marketo Sales Insight Configuration Tab](#msifeatureoverview-marketosalesinsightconfigurationtab)  
[Sales Insight Performance Reports](#msifeatureoverview-salesinsightperformancereports)  
[MSI for Mobile](#msifeatureoverview-msiformobile)  
[Language Support](#msifeatureoverview-languagesupport)
