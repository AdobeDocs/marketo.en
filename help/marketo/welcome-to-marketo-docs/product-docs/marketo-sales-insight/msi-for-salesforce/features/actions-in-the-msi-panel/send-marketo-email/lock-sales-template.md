...
1. Go to **Admin**, then click **Sales Insight**.
   ...
   ##### Under Settings, click Edit. {#locksalestemplate-undersettings-clickedit.}

   ![](assets/2.png)

   ##### Check Enable ability to lock templates. Click Save. {#locksalestemplate-checkenableabilitytolocktemplates.clicksave.}
...
##### 1. Select the email you wish to lock, then click Edit Draft. {#locksalestemplate-selecttheemailyouwishtolock-thenclickeditdraft.}

![](assets/5.png)

##### 2. In the email editor, click Email Settings. {#locksalestemplate-intheemaileditor-clickemailsettings.}
