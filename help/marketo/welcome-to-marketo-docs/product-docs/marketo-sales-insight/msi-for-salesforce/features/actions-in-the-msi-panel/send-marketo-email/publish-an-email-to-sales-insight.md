...
##### 1. Find your email, select it and click Edit Draft. {#publishanemailtosalesinsight-findyouremail-selectitandclickeditdraft.}
...
1. Check **Publish to Marketo Sales Insight**.
   ...
   ##### To set an expiration date (optional), check Set Expiration and choose a date. {#publishanemailtosalesinsight-tosetanexpirationdate(optional)-checksetexpirationandchooseadate.}
   ...
   ##### Click Save. {#publishanemailtosalesinsight-clicksave.}
...
>[!NOTE]
>
>[My Tokens](../../../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/programs/tokens/understanding-my-tokens-in-a-program.md) will not resolve when sending an email from Sales Insight on either Microsoft Dynamics or Salesforce; only standard tokens will populate (Lead, Company, etc.). Default values for tokens will work, however.
