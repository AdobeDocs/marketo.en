...
[What's in this article?](#usinginterestingmoments-44)  
[What is an interesting moment?](#usinginterestingmoments-whatisaninterestingmoment?)  
[How do I create an interesting moment?](#usinginterestingmoments-howdoicreateaninterestingmoment?)  
[How can this get even more interesting?](#usinginterestingmoments-howcanthisgetevenmoreinteresting?)  
[What does an interesting moment look like in Marketo?](#usinginterestingmoments-whatdoesaninterestingmomentlooklikeinmarketo?)  
[What does an interesting moment look like in Salesforce?](#usinginterestingmoments-whatdoesaninterestingmomentlooklikeinsalesforce?)  
[What does an interesting moment look like in Salesforce1?](#usinginterestingmoments-whatdoesaninterestingmomentlooklikeinsalesforce1?)  
{#usinginterestingmoments-44}
...
##### 1. Choose a [s](../../../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-campaigns/understanding-smart-campaigns.md) [mart campaign](../../../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-campaigns.md), preferably one your sales team would find interesting if triggered. {#usinginterestingmoments-chooseasmartcampaign-preferablyoneyoursalesteamwouldfindinterestingiftriggered.}

![](assets/image2015-1-8-18-3a8-3a54.png)

##### 2. Drag over the Interesting Moments flow step. {#usinginterestingmoments-dragovertheinterestingmomentsflowstep.}

![](assets/image2015-1-8-18-3a15-3a20.png)

##### 3. Select a type (Email, Milestone, or Web). {#usinginterestingmoments-selectatype(email-milestone-orweb).}

![](assets/image2015-1-8-18-3a17-3a16.png)

##### 4. Write a message to your sales team in the Description field that explains why this action matters. {#usinginterestingmoments-writeamessagetoyoursalesteaminthedescriptionfieldthatexplainswhythisactionmatters.}
...
Tokens! Add them in the description field to provide your sales team with more specific information like the subject line of the email the lead opened, or who was it sent by. Check out which tokens are available for use in the [Tokens for Interesting Moments](welcome-to-marketo-docs/product-docs/marketo-sales-insight/msi-for-salesforce/features/tabs-in-the-msi-panel/interesting-moments-(msi)/tokens-for-interesting-moments.md) glossary.
