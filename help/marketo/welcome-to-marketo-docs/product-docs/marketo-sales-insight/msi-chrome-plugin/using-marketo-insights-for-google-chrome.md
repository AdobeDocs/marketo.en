...
[Send an Email with Marketo Insights](#usingmarketoinsightsforgooglechrome-sendanemailwithmarketoinsights)  
[Log Email Replies with Marketo](#usingmarketoinsightsforgooglechrome-logemailreplieswithmarketo)

#### Send an Email with Marketo Insights {#usingmarketoinsightsforgooglechrome-sendanemailwithmarketoinsights}

##### 1. From the Compose Window, click the Marketo icon. {#usingmarketoinsightsforgooglechrome-fromthecomposewindow-clickthemarketoicon.}

![](assets/image2015-10-5-14-3a57-3a53.png)

##### 2. The Send button has turned Marketo purple! This email now will be sent with Marketo, all links will be tracked, and a tracking pixel will be inserted into the email. This will be recorded as a Sent Sales Email activity. {#usingmarketoinsightsforgooglechrome-thesendbuttonhasturnedmarketopurple!thisemailnowwillbesentwithmarketo-alllinkswillbetracked-andatrackingpixelwillbeinsertedintotheemail.thiswillberecordedasasentsalesemailactivity.}
