...
1. Select **Users**.
   ...
   ##### You will see a list of users here. Select your dedicated Marketo Sync user or contact your [Active Directory Federation Services (AFDS)](https://msdn.microsoft.com/en-us/library/bb897402.aspx) [administrator to create a new user that's dedicated to Marketo.](http://blogs.technet.com/b/askpfeplat/archive/2014/04/21/introduction-to-active-directory-federation-services-ad-fs-alternateloginid-feature.aspx) {#step2of3-configuresyncuserformarketo(2013on-premises)-youwillseealistofusershere.selectyourdedicatedmarketosyncuserorcontactyouractivedirectoryfederationservices(afds)administratortocreateanewuserthat'sdedicatedtomarketo.}

   ![](assets/image2015-3-26-10-3a39-3a35.png)

   ##### Select the sync user. Click ![](assets/image2015-3-26-11-3a16-3a22.png)and select Manage Roles {#step2of3-configuresyncuserformarketo(2013on-premises)-selectthesyncuser.clickandselectmanageroles}
...
1. Click the **Marketo User** field and select the sync user.
   ...
   ##### Click ![](assets/image2015-3-13-15-3a10-3a11.png)in the bottom right corner to save the changes. {#step2of3-configuresyncuserformarketo(2013on-premises)-clickinthebottomrightcornertosavethechanges.}

   ![](assets/image2014-12-11-11-3a15-3a32.png)

   ##### Click Publish All Customizations. {#step2of3-configuresyncuserformarketo(2013on-premises)-clickpublishallcustomizations.}
