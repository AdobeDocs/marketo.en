...
Step 3 of 3: Connect Marketo and Dynamics (2013 On-Premises) - Marketo Docs - Product Documentation
...
[Enter Dynamics Sync User Information](#step3of3-connectmarketoanddynamics(2013on-premises)-enterdynamicssyncuserinformation)  
[Select Fields to Sync](#step3of3-connectmarketoanddynamics(2013on-premises)-selectfieldstosync)  
[Sync Fields for a Custom Filter](#step3of3-connectmarketoanddynamics(2013on-premises)-syncfieldsforacustomfilter)  
[Enable Sync](#step3of3-connectmarketoanddynamics(2013on-premises)-enablesync)
...
1. Enter the **Username**, **Password** and Microsoft Dynamics **URL** then click **SAVE**.
   ...
   >[!NOTE]
   >
   >The Username in Marketo must match the User Name for the sync user in CRM. The format can be [ `[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#b5c0c6d0c7f5d1dad8d4dcdb9bd6dad8) or DOMAIN\user.
...
1. Click **EDIT **in **Step 2: Select Fields to Sync**.
   ...
   ##### Select the fields that you want to sync to Marketo, so they will be pre-selected. Click Save. {#step3of3-connectmarketoanddynamics(2013on-premises)-selectthefieldsthatyouwanttosynctomarketo-sotheywillbepre-selected.clicksave.}
...
##### 1. Go to Admin and select Microsoft Dynamics. {#step3of3-connectmarketoanddynamics(2013on-premises)-gotoadminandselectmicrosoftdynamics.}

![](assets/image2015-10-9-9-3a50-3a9.png)

##### 2. Click Edit on Field Sync Details. {#step3of3-connectmarketoanddynamics(2013on-premises)-clickeditonfieldsyncdetails.}

![](assets/image2015-10-9-9-3a52-3a23.png)

##### 3. Scroll down to the field and check it. The actual name must be new_synctomkto but the Display Name can be anything. Click Save. {#step3of3-connectmarketoanddynamics(2013on-premises)-scrolldowntothefieldandcheckit.theactualnamemustbenew-synctomktobutthedisplaynamecanbeanything.clicksave.}
