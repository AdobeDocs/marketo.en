...
Step 1 of 3: Install the Marketo Solution in Dynamics (2013 On-Premises) - Marketo Docs - Product Documentation
...
>
>[Download the Marketo Solution](../../../../../../welcome-to-marketo-docs/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md) before you start.
...
1. Click **Browse** and select the [downloaded solution](../../../../../../welcome-to-marketo-docs/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md). Click **Next**.

   ![](assets/image2015-3-26-9-3a54-3a1.png)

   ##### View the Solution Information and click View solution package details. {#step1of3-installthemarketosolutionindynamics(2013on-premises)-viewthesolutioninformationandclickviewsolutionpackagedetails.}

   ![](assets/image2015-11-18-11-3a12-3a8.png)

   ##### When you're done checking all the details, click Close. {#step1of3-installthemarketosolutionindynamics(2013on-premises)-whenyou'redonecheckingallthedetails-clickclose.}
