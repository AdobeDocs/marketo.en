...
When you first sync to Microsoft Dynamics, y `ou download and install the latest version of the plug-ins forMarketo Sales Insight (MSI)`. Periodically, Marketo updates these plug-ins,  `so you can return to the same place to download the new version.`
