...
Step 3 of 3: Connect Marketo and Salesforce (Enterprise/Unlimited) - Marketo Docs - Product Documentation
...
>* [Step 2 of 3: Create a Salesforce User for Marketo (Enterprise/Unlimited)](../../../../../../../../welcome-to-marketo-docs/product-docs/crm-sync/salesforce-sync/setup/professional-edition/step-2-of-3-create-a-salesforce-user-for-marketo-(professional).md) [](https://community.marketo.com/MarketoTutorial?id=kA250000000Kz5rCAC)
>

### What's in this article? {#what-s-in-this-article}

[Retrieve Sync User Security Token](#step3of3-connectmarketoandsalesforce(enterprise/unlimited)-retrievesyncusersecuritytoken)  
[Set Sync User Credentials](#step3of3-connectmarketoandsalesforce(enterprise/unlimited)-setsyncusercredentials)  
[Start Salesforce Sync](#step3of3-connectmarketoandsalesforce(enterprise/unlimited)-startsalesforcesync)  
[Verify Sync](#step3of3-connectmarketoandsalesforce(enterprise/unlimited)-verifysync)
...
1. In Marketo, go to **Admin**, select **CRM**, and click **Sync with [Salesforce.com](http://Salesforce.com)**
   ...
   >
   >
   >Be sure to [hide all fields you do not need](../../../../../../../../welcome-to-marketo-docs/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync:-field-sync/hide-a-salesforce-field-from-the-marketo-sync.md) in Marketo from the sync user before clicking **Sync Fields**. Once you click Sync Fields all fields the user can see will be created in Marketo permanently and cannot be deleted.
