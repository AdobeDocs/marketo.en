...
Step 2 of 3: Create a Salesforce User for Marketo (Enterprise/Unlimited) - Marketo Docs - Product Documentation
...
[Create a Profile](#step2of3-createasalesforceuserformarketo(enterprise/unlimited)-createaprofile)  
[Set Profile Permissions](#step2of3-createasalesforceuserformarketo(enterprise/unlimited)-setprofilepermissions)  
[Set Field Permissions](#step2of3-createasalesforceuserformarketo(enterprise/unlimited)-setfieldpermissions)  
[Create Marketo-Salesforce Sync Account](#step2of3-createasalesforceuserformarketo(enterprise/unlimited)-createmarketo-salesforcesyncaccount)
...
<table style="text-align: left;" class="confluenceTable"> 
 <tbody> 
  <tr> 
...
>[!TIP]
>
>Create a dedicated Salesforce account (e.g. [ `[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#a3cec2d1c8c6d7cce3daccd6d1c0ccced3c2cdda8dc0ccce)) to distinguish the changes made by Marketo versus other Salesforce users.
