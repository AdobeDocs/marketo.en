...
Step 3 of 3: Connect Marketo and Salesforce (Professional) - Marketo Docs - Product Documentation
...
[Retrieve Sync User Security Token](#step3of3-connectmarketoandsalesforce(professional)-retrievesyncusersecuritytoken)  
[Set Sync User Credentials](#step3of3-connectmarketoandsalesforce(professional)-setsyncusercredentials)  
[Start Salesforce Sync](#step3of3-connectmarketoandsalesforce(professional)-startsalesforcesync)  
[Verify Sync](#step3of3-connectmarketoandsalesforce(professional)-verifysync)
...
1. Read the warning, then click **Confirm Credentials**.
   ...
   >[!CAUTION]
   >
   >If you want to look over the [mappings and customize them](../../../../../../welcome-to-marketo-docs/product-docs/crm-sync/salesforce-sync/setup/optional-steps/edit-initial-field-mappings.md), this is your only chance to do so! Once you click Start Salesforce Sync, it's done.
