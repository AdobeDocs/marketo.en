...
[Marketo Sales Engage Launch and ToutApp Updates](#releasenotes-spring'18-marketosalesengagelaunchandtoutappupdates)  
[Marketo Sky Open Beta](#releasenotes-spring'18-marketoskyopenbeta)  
[Performance Insights](#releasenotes-spring'18-performanceinsights)  
[ContentAI](#releasenotes-spring'18-contentai)  
[Integration and APIs](#releasenotes-spring'18-integrationandapis)  
[Privacy Enhancements](#releasenotes-spring'18-privacyenhancements)

#### [Marketo Sales Engag](../../../welcome-to-marketo-docs/product-docs/marketo-sales-connect/getting-started-(msc)/sales-connect-overview.md) [e Launch](../../../welcome-to-marketo-docs/product-docs/marketo-sales-connect/getting-started-(msc)/sales-connect-overview.md)and ToutApp Updates {#releasenotes-spring'18-marketosalesengagelaunchandtoutappupdates}
...
#### [Marketo Sky Open Beta](https://help.marketo.com/hc/en-us) {#releasenotes-spring'18-marketoskyopenbeta}
...
#### [Performance Insights](../../../welcome-to-marketo-docs/product-docs/reporting/performance-insights/performance-insights-overview.md) {#releasenotes-spring'18-performanceinsights}
...
#### Content`<sup>AI</sup>`  {#releasenotes-spring'18-contentai}

** [Goal Setting](../../../welcome-to-marketo-docs/product-docs/predictive-content/getting-started-(predictive-content-and-content-ai)/algorithm-goal-settings.md)**

Set the objective of the Content`<sup>AI</sup>` optimization algorithm to drive more views, clicks, or conversions.

#### Integration and APIs {#releasenotes-spring'18-integrationandapis}

** [Facebook Workplace Integration](../../../welcome-to-marketo-docs/product-docs/administration/additional-integrations/add-workplace-by-facebook-as-a-launchpoint-service.md)**
