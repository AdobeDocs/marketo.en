...
[Subscribe to a Smart List](#releasenotes-fall'15-subscribetoasmartlist)  
[Marketo Custom Objects](#releasenotes-fall'15-marketocustomobjects)  
[Marketo Insights for Google Chrome](#releasenotes-fall'15-marketoinsightsforgooglechrome)  
[Marketo Mobile Engagement — Tokens, Send Sample & Preview](#releasenotes-fall'15-marketomobileengagement—tokens-sendsample&preview)  
[Smart Campaigns in Moments](#releasenotes-fall'15-smartcampaignsinmoments)  
[RTP - Content Analytics and Recommendations](#releasenotes-fall'15-rtp-contentanalyticsandrecommendations)  
[RTP - Clone an RTP Campaign](#releasenotes-fall'15-rtp-cloneanrtpcampaign)  
[Rich Text Editor Improvements](#releasenotes-fall'15-richtexteditorimprovements)  
[Microsoft Dynamics - Validate Sync](#releasenotes-fall'15-microsoftdynamics-validatesync)  
[Add Fields to CRM Custom Object Sync](#releasenotes-fall'15-addfieldstocrmcustomobjectsync)  
[Changes to Security Features](#releasenotes-fall'15-changestosecurityfeatures)  
[IE 11 Support (and deprecating support for IE 9)](#releasenotes-fall'15-ie11support(anddeprecatingsupportforie9))  
[Lightning UI support for MSI](#releasenotes-fall'15-lightninguisupportformsi)  
[New Dynamics Plug-in](#releasenotes-fall'15-newdynamicsplug-in)  
[Search by URL of Landing Page in Design Studio](#releasenotes-fall'15-searchbyurloflandingpageindesignstudio)  
The following features are included in the Fall '15 release. Please check your Marketo Edition for feature availability.

#### [Subscribe to a Smart List](../../../welcome-to-marketo-docs/product-docs/reporting/basic-reporting/report-subscriptions/subscribe-to-a-smart-list.md) {#releasenotes-fall'15-subscribetoasmartlist}
...
#### [Marketo Custom Objects](../../../welcome-to-marketo-docs/product-docs/administration/marketo-custom-objects.md) {#releasenotes-fall'15-marketocustomobjects}
...
#### [Marketo Insights for Google Chrome](../../../welcome-to-marketo-docs/product-docs/marketo-sales-insight/msi-chrome-plugin/using-marketo-insights-for-google-chrome.md) {#releasenotes-fall'15-marketoinsightsforgooglechrome}
...
#### Marketo Mobile Engagement — [Tokens](../../../welcome-to-marketo-docs/product-docs/mobile-marketing/push-notifications/configure-mobile-push-notification.md), [Send Sample](../../../welcome-to-marketo-docs/product-docs/mobile-marketing/push-notifications/send-a-push-notification-sample.md) & [Preview](../../../welcome-to-marketo-docs/product-docs/mobile-marketing/push-notifications/preview-a-push-notification.md) {#releasenotes-fall'15-marketomobileengagement—tokens-sendsample&preview}

Easily personalize push notifications with [tokens](https://docs.marketo.com/pages/viewpage.action?pageId=7512454).

![](assets/image2015-10-1-13-3a44-3a58.png)

You can also [preview](../../../welcome-to-marketo-docs/product-docs/mobile-marketing/push-notifications/preview-a-push-notification.md) or send out a [sample](../../../welcome-to-marketo-docs/product-docs/mobile-marketing/push-notifications/send-a-push-notification-sample.md) push notification before you deploy it to customers.

![](assets/image2015-10-1-13-3a45-3a25.png)

![](assets/image2015-10-1-13-3a46-3a20.png)

#### [Smart Campaigns in Moments](../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/mobile-apps/marketo-moments/understanding-moments/understanding-smart-campaign-cards.md) {#releasenotes-fall'15-smartcampaignsinmoments}
...
#### RTP - [Content Analytics](../../../welcome-to-marketo-docs/product-docs/web-personalization/understanding-web-personalization/understanding-content-analytics.md) and [Recommendations](#) {#releasenotes-fall'15-rtp-contentanalyticsandrecommendations}
...
#### [RTP - Clone an RTP Campaign](../../../welcome-to-marketo-docs/product-docs/web-personalization/working-with-web-campaigns/clone-a-web-campaign.md) {#releasenotes-fall'15-rtp-cloneanrtpcampaign}
...
* VML is now supported within your HTML code:  
  ...
  **
  ...
  ```
  <v:fill type="tile" src="<a href="http://i.imgur.com/YJOX1PC.png" class="external-link" rel="nofollow">http://i.imgur.com/YJOX1PC.png</a>" color="#7bceeb"/>
  ```
...
#### [Microsoft Dynamics - Validate Sync](../../../welcome-to-marketo-docs/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/validate-microsoft-dynamics-sync.md) {#releasenotes-fall'15-microsoftdynamics-validatesync}
