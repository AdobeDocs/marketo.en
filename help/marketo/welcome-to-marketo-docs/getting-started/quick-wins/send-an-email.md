...
[Create an Email Program](#sendanemail-createanemailprogram)  
[Define your Audience](#sendanemail-defineyouraudience)  
[Create an Email](#sendanemail-createanemail)
...
1. Enter a **Name **and select **Email** for **Program Type.**
   ...
   ##### Under Channel, select Email Send and click Create.  {#sendanemail-underchannel-selectemailsendandclickcreate.}
...
1. Click the **Email Actions** drop-down and `select **Approve**`.
   ...
   >[!TIP]
   >
   >Want to send yourself a quick sample to see how your email looks prior to launching? Select **Send Sample** in the menu above, or click **Email Actions** then [**Send Sample**](../../../welcome-to-marketo-docs/product-docs/email-marketing/general/creating-an-email/send-a-sample-email.md).
