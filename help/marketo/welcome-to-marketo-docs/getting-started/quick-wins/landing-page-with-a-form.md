...
Landing Page with a Form - Marketo Docs - Product Documentation

### Mission: Create a landing page with a form to acquire new people. {#landingpagewithaform-mission-createalandingpagewithaformtoacquirenewpeople.}
...
[STEP 1: Create a Program](#landingpagewithaform-step1-createaprogram)  
[STEP 2: Create a Form](#landingpagewithaform-step2-createaform)  
[STEP 3: Create a Landing Page and Add Your Form](#landingpagewithaform-step3-createalandingpageandaddyourform)  
[STEP 4: Approve Your Landing Page](#landingpagewithaform-step4-approveyourlandingpage)  
[STEP 5: Test Your Form](#landingpagewithaform-step5-testyourform)
...
1. Enter a program **Name**, select a** Channel** and click** Create**.
   ...
   >
   >
   >A program is one specific marketing initiative. The **channel** is intended to be the delivery mechanism, like Webinar, Sponsorship, or Online Ad. You may see different channel options in your drop-down, depending on what's available in your own instance. You can also [create your own channel.](../../../welcome-to-marketo-docs/product-docs/administration/tags/create-a-program-channel.md)
...
1. Enter the URL.
   ...
   >**Definition**
   >
   >The Follow Up Page is where the visitor is re-directed after filling out the form. External URL is one option but there are more. See [Set a Form Thank You Page](../../../welcome-to-marketo-docs/product-docs/demand-generation/forms/creating-a-form/set-a-form-thank-you-page.md).
...
1. Search for the unique email address you used when filling out the form.
   ...
   ### Mission Complete! {#landingpagewithaform-missioncomplete!}
