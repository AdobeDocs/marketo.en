...
### Mission: Alert the sales rep when a person fills out a form on your web site {#alertthesalesrep-mission-alertthesalesrepwhenapersonfillsoutaformonyourwebsite}
...
[Step 1: Create an Alert Email](#alertthesalesrep-step1-createanalertemail)  
[Step 2: Create an Alert Trigger Campaign](#alertthesalesrep-step2-createanalerttriggercampaign)
...
1. Find and select the **{{SP_Send_Alert_Info}}** **Token **and click **Insert**.
   ...
   >[!NOTE]
   >
   >{{SP_Send_Alert_Info}} is a special token for alert emails. See [Use the Send Alert Info Token](../../../welcome-to-marketo-docs/product-docs/email-marketing/general/using-tokens/use-the-send-alert-info-token-{{sp_send_alert_info}}.md) to learn more.

   ##### Click Save. {#alertthesalesrep-clicksave.}
...
## Step 3: Test It Out! {#alertthesalesrep-step3-testitout!}
...
1. You should receive your email shortly. Once you've verified that everything works as it should, remove your email address from the Send Alert flow (see step 2.7 above).
   ...
   ### Mission Complete! {#alertthesalesrep-missioncomplete!}
