...
Configure Protocols for Marketo - Marketo Docs - Product Documentation
...
>[!NOTE]
>
>This specific article is meant to be viewed by the IT department of the company wishing to implement these protocols.

### What's in this article? {#what-s-in-this-article}

[Step 1: Create DNS Records for Landing Pages and Email](#configureprotocolsformarketo-step1-creatednsrecordsforlandingpagesandemail)  
[Step 2: Whitelist Marketo IPs](#configureprotocolsformarketo-step2-whitelistmarketoips)  
[Step 3: Set up SPF and DKIM](#configureprotocolsformarketo-step3-setupspfanddkim)  
[Step 4: Set up MX Records for Your Domain](#configureprotocolsformarketo-step4-setupmxrecordsforyourdomain)
...
>[!NOTE]
>
>`Postini employs a unique technology and requires whitelisting IP ranges. See` [ `Whitelisting with Postini`](https://nation.marketo.com/docs/DOC-1066) `.`
