...
+ Product Docs {#product-docs}
  ...
  + Demand Generation {#demand-generation}
    ...
    + Images and Files {#images-and-files}
      ...
      + {hide-from-toc} [C2PA metadata in Marketo Engage](product-docs/demand-generation/images-and-files/c2pa-metadata.md)
  ...
  + Email Marketing {#email-marketing}
    ...
    + Email Designer {#email-designer}
      ...
      + [Use modules in the Email Designer](product-docs/email-marketing/email-designer/email-modules.md)
...
+ Release Notes {#release-notes}
  ...
  + [Previous Releases](release-notes/previous-releases.md)
  + {hide-from-toc} Previous Releases {#previous-releases}
    + 2026 {#2026}
