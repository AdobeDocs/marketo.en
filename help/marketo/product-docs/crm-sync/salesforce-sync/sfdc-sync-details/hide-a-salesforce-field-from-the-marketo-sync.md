...
description: "Learn how to hide a Salesforce field from the Marketo sync to optimize performance. Use field-level security on the sync user profile to exclude unneeded fields."
