...
description: "Learn how to create a Salesforce user for Marketo with Professional edition. Set page layouts and create the sync user with field permissions for lead and contact."
