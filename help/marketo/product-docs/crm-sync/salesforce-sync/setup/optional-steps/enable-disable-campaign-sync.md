...
This option allows Marketo Engage to sync its program membership and statuses with Salesforce campaigns and vice versa.
...
>* [Set Default Lead Last Name and Company Values](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/optional-steps/set-default-person-last-name-and-company-name.md){target="_blank"}
>* [Customize Activities Sync](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/optional-steps/customize-activities-sync.md){target="_blank"}
