...
1. Log in to Salesforce and click **[!UICONTROL Setup]**.

   ![](assets/image2016-5-23-13-3a15-3a21.png)

1. In the [!UICONTROL Build] menu on the left, click **[!UICONTROL Customize]** and select **[!UICONTROL Leads]**. Click **[!UICONTROL Fields]**.
...
1. In the Build menu on the left, click **[!UICONTROL Customize]** and select Contacts. Click Fields.
...
1. Type "Fields" into the Nav Search without pressing Enter. Fields appears under different objects; Click **[!UICONTROL Fields]** under Leads.
