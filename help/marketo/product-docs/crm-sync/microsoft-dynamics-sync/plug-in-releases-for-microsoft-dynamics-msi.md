...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1"><p>Bug fix: To Hide MSI Secret Password on MSD API Config</p></td> 
  </tr> 
  <tr> 
   <td colspan="1">05/26/20</td> 
   <td colspan="1">2.0.0.18</td> 
   <td colspan="1"><p>Bug fix: To change MSI role Id Validation for displaying MSI buttons</p></td> 
  </tr> 
  <tr> 
   <td colspan="1">05/21/20</td> 
   <td colspan="1">2.0.0.17</td> 
   <td colspan="1"><p>Bug fix: Unhide owner field and making fields non mandatory</p></td> 
  </tr> 
  <tr> 
   <td colspan="1">04/28/20</td> 
   <td colspan="1">2.0.0.16</td> 
   <td colspan="1"><p>Bug fix: Removing MSD CRM sitemap setting link dependency</p></td> 
  </tr> 
 </tbody> 
</table>
