...
1. Enter the **Username**, **Password **a Microsoft Dynamics **URL**, and an *optional*** Client Id. **Click **Save** when done.
   ...
   >[!NOTE]
   >
   >The Username in Marketo must match the User Name for the sync user in CRM. The format can be [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#1e6b6d7b6c5e7a71737f7770307d7173) or DOMAIN\user.
