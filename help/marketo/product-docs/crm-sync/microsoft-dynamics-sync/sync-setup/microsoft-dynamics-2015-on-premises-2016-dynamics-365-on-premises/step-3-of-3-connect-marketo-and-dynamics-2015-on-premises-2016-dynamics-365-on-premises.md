...
1. Enter the **Username**, **Password **a Microsoft Dynamics **URL**, and an *optional*** Client Id. **Click **Save** when done.
   ...
   >[!NOTE]
   >
   >The Username in Marketo must match the User Name for the sync user in CRM. The format can be [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#592c2a3c2b193d3634383037773a3634) or DOMAIN\user.
