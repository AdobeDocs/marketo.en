...
1. Enter the **Username**, **Password** and CRM **URL **then click **Save**.
   ...
   >[!NOTE]
   >
   >The Username in Marketo must match the User Name for the sync user in CRM. The format can be [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#0e7b7d6b7c4e6a61636f6760206d6163) or DOMAIN\user.
