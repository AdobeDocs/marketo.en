...
1. Enter the **Username**, **Password**, and Microsoft Dynamics **URL** (Client ID and Client Secret are optional). Click **Save** when done.
   ...
   >[!NOTE]
   >
   >The Username in Marketo must match the User Name for the sync user in CRM. The format can be [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#453036203705212a28242c2b6b262a28) or DOMAIN\user.
