...
1. Enter the **Username**, **Password**, and Microsoft Dynamics **URL** (Client ID and Client Secret are optional). Click **Save** when done.
   ...
   >[!NOTE]
   >
   >The Username in Marketo must match the User Name for the sync user in CRM. The format can be [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#0b7e786e794b6f64666a626525686466) or DOMAIN\user.
