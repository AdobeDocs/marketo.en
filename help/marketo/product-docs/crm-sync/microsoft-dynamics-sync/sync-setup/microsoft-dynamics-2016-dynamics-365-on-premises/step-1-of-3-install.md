...
Before you can sync Microsoft Dynamics 2016 On-Prem/Dynamics 365 with Marketo Engage, you need to first install the Marketo solution in Dynamics.
...
1. Log in to Dynamics. Click the **[!UICONTROL Microsoft Dynamics CRM]** drop-down menu and select **[!UICONTROL Settings]**.
...
1. Click **[!UICONTROL Browse]** and select the solution you [downloaded](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md){target="_blank"}. Click **Next**.
...
1. Select the Marketo solution and click **[!UICONTROL Publish All Customizations]**.
   ...
   >[!MORELIKETHIS]
   >
   >[Install Marketo for Dynamics 2015 On-Prem and 2016 365 On-Prem Step 2 of 3](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2016-dynamics-365-on-premises/step-2-of-3-set-up.md){target="_blank"}
