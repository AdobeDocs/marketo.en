...
1. Enter the **Username**, **Password** and Microsoft Dynamics **URL** then click **SAVE**.
   ...
   >[!NOTE]
   >
   >The Username in Marketo must match the User Name for the sync user in CRM. The format can be [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#552026302715313a38343c3b7b363a38) or DOMAIN\user.
