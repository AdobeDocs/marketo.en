...
1. Enter the **Username**, **Password** and Microsoft Dynamics **URL** then click **SAVE**.
   ...
   >[!NOTE]
   >
   >The Username in Marketo must match the User Name for the sync user in CRM. The format can be [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#f683859384b692999b979f98d895999b) or DOMAIN\user.
