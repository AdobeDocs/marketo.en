...
1. Enter the **Username**, **Password** and Microsoft Dynamics **URL** then click **SAVE**.
   ...
   >[!NOTE]
   >
   >The Username in Marketo must match the User Name for the sync user in CRM. The format can be [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#c1b4b2a4b381a5aeaca0a8afefa2aeac) or DOMAIN\user.
