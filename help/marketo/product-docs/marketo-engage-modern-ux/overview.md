...
>[!TIP]
>
>Using the search in the tree will only yield results from the section you are in (e.g., Marketing Activities). If you'd like to search your entire instance, use the global search.
