...
Here are the steps you need to take to configure [!DNL Marketo Sales Insight] in [!DNL Salesforce] Enterprise/Unlimited Editions. Let's get started.
...
1. Obtain your MSI credentials in Marketo. Go to the [!UICONTROL Admin] area and select **[!UICONTROL Sales Insight]**.
...
1. You will see a confirmation pop-up. Click **[!UICONTROL OK]**.
   ...
   >[!TIP]
   >
   >Keep this window open. You'll need this information later in [!DNL Salesforce].
...
1. Enter the [!UICONTROL Remote Site Name] (it can be something like "MarketoAPI"). Enter [!UICONTROL Remote Site URL], which is your API URL from [!UICONTROL Rest API Configuration] panel in Marketo. Click **[!UICONTROL Save]**. You have now created remote site settings for Rest API.

   >[!NOTE]
   >
   >_You_ choose your **[!UICONTROL Remote Site Name]** (MarketoAPI is used here). The **[!UICONTROL Remote Site URL]** can be found in the Marketo Host field of your Edit API Configuration dialog box from Step 3 in the "Configure [!DNL Sales Insight] in Marketo" section.
...
1. Enter "[!DNL Marketo Sales Insight]" as the **[!UICONTROL Section Name]**. Select **[!UICONTROL 1-Column]** and click **[!UICONTROL OK]**.
...
1. Click on **[!UICONTROL Fields]** on the left. Then search and drag the **[!UICONTROL Urgency]** label into the **[!UICONTROL Marketo Sales Insight]** layout.
...
1. Repeat the above step for these fields as well.
   ...
   <table> 
    <tbody> 
     <tr> 
      <td>[!UICONTROL Last Interesting Moment]</td> 
     </tr> 
     <tr> 
     ...
     <tr> 
      <td>[!UICONTROL Last Marketo Activity by Sales]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL Last Marketo Engagement by Sales]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL MSI Contact Id]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL Relative Score]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL Relative Score Value]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL Urgency]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL Urgency Value]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL View in Marketo]</td> 
     </tr> 
    </tbody> 
   </table>
...
1. Repeat steps 5-7 to add Visualforce page sections and [!DNL Sales Insight] fields for **[!UICONTROL Contact]**, **[!UICONTROL Account]** and **[!UICONTROL Opportunity]**.

1. Repeat steps 8-10 to add [!DNL Sales Insight] fields from the list below for **[!UICONTROL Contact]**. Be sure to save any changes.
...
<table> 
    <tbody> 
     ...
     <tr> 
      <td>[!UICONTROL MKTO Lead Score]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL Relative Score]</td> 
     </tr> 
     ...
     <tr> 
      <td>[!UICONTROL Sales Insight - Opens contact full list page]</td> 
     </tr> 
     <tr> 
      <td>[!UICONTROL Urgency]</td> 
     </tr> 
...
>* [Add Marketo Tab to [!DNL Salesforce]](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/configuration/add-marketo-tab-to-salesforce.md)
