...
The Lead Feed is an up-to-the-minute list of interesting events done by your leads. You'll find it on the right-hand side when you click the Marketo tab. It is like an RSS or [!DNL Twitter] feed - the most recent updates are at the top of the list. Use this to jump on leads while you are still fresh in their minds.
...
You can also get Lead Feed updates by RSS feed.  An RSS feed lets you receive updates on your leads even if you are not connected to [!DNL Salesforce]. The feed has the same information as the Lead Feed in [!DNL Salesforce] as well as the following (when available):
