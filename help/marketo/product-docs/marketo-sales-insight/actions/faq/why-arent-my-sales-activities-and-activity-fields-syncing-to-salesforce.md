...
* Make sure you are connected to Salesforce. Each user will need to have a connection to log their email and calls to Salesforce.
...
* If you are a Salesforce Admin, you can see your Field Accessibility under the Security Controls tab. The main objects that Actions will interact with are: Leads, Contacts, Accounts, Opportunities, and Task/Activities.
