...
The [Me tab](/help/marketo/product-docs/marketo-sales-insight/actions/analytics/understanding-the-me-tab.md){target="_blank"} is a great place to check on the engagement of your emails, templates, and links. If you are an admin in Sales Insight Actions, you can filter by any user on your team to see their stats.
