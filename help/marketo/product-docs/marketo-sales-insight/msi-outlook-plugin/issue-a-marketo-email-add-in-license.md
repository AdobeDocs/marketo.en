...
1. Under the **[!UICONTROL Email Add-in]** tab, click **[!UICONTROL Issue License]**.
...
1. Enter the sales reps' email addresses that need to be authorized to use the plugin and click **[!UICONTROL Issue License]**. To enter multiple email addresses, separate them with a comma.
   ...
   >[!NOTE]
   >
   >* To install the plugin remotely, leave the _Send Registration email with download link_ checkbox unchecked and send your IT team your [Enterprise Key](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-add-in-for-outlook-with-an-enterprise-key.md).
   >
   >* If your sales reps have admin access to their computers, check the _Send Registration email with download link_ checkbox and you are done. The recipients have **30 days** to click the link in the email before it expires.

>[!MORELIKETHIS]
>
>* [Install the Marketo Add-in for [!DNL Outlook] with an Enterprise Key](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-add-in-for-outlook-with-an-enterprise-key.md)
>* [Install the Marketo Email Add-in for [!DNL Outlook] with a Registration Code](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-email-add-in-for-outlook-with-a-registration-code.md)
>* [Upgrade your Marketo Email Add-In for [!DNL Outlook]](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/upgrade-your-marketo-email-add-in-for-outlook.md)
