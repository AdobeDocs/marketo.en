...
##### 1. [Create a report](../../../../product-docs/reporting/basic-reporting/creating-reports/create-a-report-in-a-program.md) and select the  Company Web Activity Report  [report type](report-type-overview.md). {#create-a-report-and-select-the-company-web-activity-report-report-type}

##### 2. Choose to [display known or anonymous people](https://docs.marketo.com/display/DOCS/Display+Known+or+Anonymous+People+in+Web+Reports) in the report. {#choose-to-display-known-or-anonymous-people-in-the-report}
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   >
   >
   >Learn about other interesting reports in the [Basic Reporting](../../../../product-docs/reporting/basic-reporting.md) deep dive.
