...
You can create a report showing which stage of your&nbsp; [Revenue Cycle Model](../../../../product-docs/reporting/revenue-cycle-analytics/revenue-cycle-models.md)&nbsp;your people are in. The report includes any stage from the specified model as long as there is a person balance for the given date range of the report.&nbsp;
...
1. Click the **Report** tab. Now you can see which stage of your revenue model your people are in, and focus on any bottlenecks.
   ...
   >
   >
   >Learn how to add columns and more in [Basic Reporting](../../../../product-docs/reporting/basic-reporting.md).
