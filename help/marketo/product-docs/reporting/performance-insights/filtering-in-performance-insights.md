...
##### Click the + to start adding filters. {#click-the-to-start-adding-filters}
...
##### Clicking a category reveals multiple sub-categories. {#clicking-a-category-reveals-multiple-sub-categories}

![](assets/two-1.png)

##### Choose a sub-category and search for/select a value. {#choose-a-sub-category-and-search-for-select-a-value}

![](assets/three.png)

##### The charts update to reflect the filter(s) selected. {#the-charts-update-to-reflect-the-filter-s-selected}

![](assets/four-1.png)

##### You can add additional filters by following the same steps. {#you-can-add-additional-filters-by-following-the-same-steps}

![](assets/five.png)

##### You can remove a filter at any time by clicking the X next to it. Remove all filters at once by clicking the X to the far right. {#you-can-remove-a-filter-at-any-time-by-clicking-the-x-next-to-it-remove-all-filters-at-once-by-clicking-the-x-to-the-far-right}
