...
This flow step can be used in Marketo Smart Campaigns to add people as leads or contacts in a Microsoft campaign. If the lead does not yet exist in [!DNL Dynamics], it will automatically be synced over and get added to the campaign.

>[!NOTE]
>
>This flow action is available for Trigger Campaigns only.

In your smart campaign, find and select the [!DNL Dynamics] campaign you want to add your people to.
...
>* The campaign is not active in Microsoft [!DNL Dynamics]
...
In your smart campaign, find and select the [!DNL Dynamics] campaign you want to remove your people from.
