...
This is an example of an event program with a registration page, three invitation emails, and follow-up emails utilizing a Marketo Engage Event Program. Suitable for all events where you require registrations, including roadshows, lunches, dinners, or presentations at trade show events. Use the Marketo Engage Events App for check-in and attendance tracking on your iPad.
...
>[!NOTE]
>
>Before the event, download the registration information to your iPad. Then check visitors in and synchronize the attendance information back to Marketo Engage. If you don't have a tablet, you can [import attendees](/help/marketo/product-docs/core-marketo-concepts/programs/working-with-programs/import-members-from-a-spreadsheet-into-a-program.md){target="_blank"} afterwards, under the Program's "Members" tab, before sending your follow-up emails.
