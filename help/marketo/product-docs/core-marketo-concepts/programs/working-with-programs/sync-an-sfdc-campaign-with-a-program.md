...
Marketo allows you to sync your programs with [!DNL Salesforce] campaigns to maintain the same list of people in both systems, including their statuses. Let's get started!  
...
1. Select **[!UICONTROL Create New]** or choose an existing [!DNL Salesforce] campaign.
   ...
   >[!TIP]
   >
   >If you select an existing [!DNL Salesforce] campaign, make sure to [match the program statuses of the [!DNL Salesforce] campaign and the Marketo program](/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/how-to-match-program-statuses-and-salesforce-campaign-statuses-prior-to-sync.md).
