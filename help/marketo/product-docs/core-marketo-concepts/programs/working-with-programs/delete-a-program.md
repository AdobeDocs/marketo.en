...
##### 1. Select the program you'd like to delete.  {#select-the-program-youd-like-to-delete}

![](assets/image2014-9-23-15-3a40-3a57.png)  

##### 2. Click Program Actions. Click Delete.  {#click-program-actions-click-delete}

![](assets/image2014-9-23-15-3a41-3a11.png)  

##### 3. Select the Delete all option. Review the side effects of the program's deletion, then click Delete to confirm. {#select-the-delete-all-option-review-the-side-effects-of-the-programs-deletion-then-click-delete-to-confirm}
