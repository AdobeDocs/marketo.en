...
1. Click **[!UICONTROL Program Actions]**. Click **[!UICONTROL Delete]**.

   ![](assets/image2014-9-23-15-3a41-3a11.png)

1. Select the Delete all option. Review the side effects of the program's deletion, then click **[!UICONTROL Delete]** to confirm.
