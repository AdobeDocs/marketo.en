...
* The folder and assets are no longer visible in search results. If you search for a Program or Event that is inside an archived folder, the results return a collapsed view of the archived folder
...
* Archived pages cannot be used in landing page test groups
