...
##### 2.  Click Notifications to view all your notifications. {#click-notifications-to-view-all-your-notifications}
...
##### 1. Go to Notifications and click Subscribe. {#go-to-notifications-and-click-subscribe}

![](assets/image2014-10-10-12-3a3-3a29.png) 

##### 2.  Select the Notification Type and enter the email address(es) you want notifications sent to. {#select-the-notification-type-and-enter-the-email-address-es-you-want-notifications-sent-to}
