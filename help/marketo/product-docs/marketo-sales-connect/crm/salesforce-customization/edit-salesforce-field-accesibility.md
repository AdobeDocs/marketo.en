...
description: "Learn how to edit Salesforce field accessibility for Sales Connect. Control which fields Sales Connect can read or write in Salesforce."
...
* Salesforce's Field Level security gives [!DNL Salesforce] admins the ability to put restrictions around what information is viewable and editable by users. When setting field level security, make sure it is not interfering with the ability for users to see [!DNL Sales Connect] fields.
