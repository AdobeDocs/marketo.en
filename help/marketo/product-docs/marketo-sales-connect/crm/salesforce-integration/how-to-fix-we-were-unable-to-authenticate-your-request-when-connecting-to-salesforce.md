...
description: "Get help fixing the We Were Unable to Authenticate Your Request error when connecting Sales Connect to Salesforce. Troubleshoot authentication issues."
