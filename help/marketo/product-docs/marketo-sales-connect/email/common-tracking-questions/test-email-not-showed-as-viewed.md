...
1. Go to the [[!UICONTROL Command Center]](https://toutapp.com/).

1. Find the email you sent yourself in the [!UICONTROL Sent folder] and select it.

1. Click the **[!UICONTROL Details]** button. You should see your own views showing up there.
