...
* When using `{{company_friendly}}`, make sure you separate Inc. or Co. with a comma in the contact details. This is how [!DNL Sales Connect] knows what to remove when pulling in the value.
