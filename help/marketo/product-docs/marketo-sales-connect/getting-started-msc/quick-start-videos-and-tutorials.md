...
Quick Start Videos and Tutorials - Marketo Docs - Product Documentation

### What's in this article? {#whats-in-this-article}

[Enabling Marketing Insights](#enabling-marketing-insights)  
[Email Settings Overview](#email-settings-overview)  
[Installing Customizations in Salesforce](#installing-customizations-in-salesforce)  
[Salesforce Overview](#salesforce-overview)

>[!NOTE]
>
>Marketo Sales Engage was recently renamed Marketo Sales Connect. We are in the process of updating all videos, but some may still show the old name.
