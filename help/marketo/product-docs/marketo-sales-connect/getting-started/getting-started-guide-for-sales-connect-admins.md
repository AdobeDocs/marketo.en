...
To learn more about how to connect to Marketo and grant sales users access to the connection, [click here](/help/marketo/product-docs/marketo-sales-connect/marketo/set-up-your-marketo-connection.md).  
