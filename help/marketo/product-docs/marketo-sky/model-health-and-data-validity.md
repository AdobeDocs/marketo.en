...
* **[!UICONTROL Data Completeness]**: Percentage of data attributes that are present/complete.
* **[!UICONTROL Data Quality]**: Percentage of attributes that contain good, usable data.
