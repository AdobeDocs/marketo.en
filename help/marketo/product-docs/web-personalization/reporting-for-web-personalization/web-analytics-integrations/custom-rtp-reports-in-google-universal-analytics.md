...
## Setting up a [!UICONTROL Custom Report] {#setting-up-a-custom-report}
...
1. Name the 1st tab **[!UICONTROL Industry]**.

>[!NOTE]
>
>You will **Duplicate this tab** and create additional similar ones - step 5)

1. Select the **[!UICONTROL Explorer]** report type.

   ![](assets/image2015-3-22-16-3a15-3a25.png)

1. In the **[!UICONTROL Metric Groups]** section, select the metrics that are relevant for your business.
...
1. Set the 1st tab name to **[!UICONTROL All Engagement]**.
...
1. In the [!UICONTROL Metric Groups] section, select the metrics that are relevant for your business. Here is a recommendation:
