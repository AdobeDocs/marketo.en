...
##### 2. Click Create New Web Campaign. {#click-create-new-web-campaign}

![](assets/create-new-web-campaign-create-hand.jpg)  

##### 3. Name your campaign. {#name-your-campaign}

![](assets/set-web-campaign-my-campaign-hand.jpg)  

##### 4. Select a Target Segment. {#select-a-target-segment}

![](assets/set-web-campaign-education.jpg)

##### 5. Click Templates. {#click-templates}

![](assets/templates.png)

##### 6. Select the appropriate area for your campaign to see and select a template that works for you. {#select-the-appropriate-area-for-your-campaign-to-see-and-select-a-template-that-works-for-you}
...
##### 7. Customize the template. {#customize-the-template}
