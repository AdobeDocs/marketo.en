...
* Access Email
    ...
    * Set Branded Domain - Enables users to work with branding domains. See: [Add Multiple Branding Domains](../../../../product-docs/administration/email-setup/add-multiple-branding-domains.md)
