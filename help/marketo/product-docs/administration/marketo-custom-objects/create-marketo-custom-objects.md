...
Use custom objects in Marketo to track metrics specific to your business. This could be anything from cars to courses&mdash;whatever you would like to model in Marketo to run your campaigns.
...
This example shows a Car custom object, for use in a one-to-many structure. Later, you will create a course custom object and an intermediary object to use in a many-to-many structure.
...
1. Enter a [!UICONTROL Display Name]. The [!UICONTROL API Name] and [!UICONTROL Plural Name] populate automatically. Enter a [!UICONTROL Description] (optional).
   ...
   >[!NOTE]
   >
   >You can edit these fields when you are creating them, but after they are saved, you can only edit the [!UICONTROL Plural Name] field and the **[!UICONTROL Show in Lead Detail]** slider.
...
1. The custom object information displays the content you entered. Notice that it is in a **[!UICONTROL Draft]** state.
...
This example shows a course custom object, which you will use for creating a many-to-many relationship between people or companies and courses. When you are done, you will create an intermediary object to connect it to people or companies in your database.

>[!NOTE]
>
>For a many-to-many relationship, you do not need to create a link in the custom object. Instead, you will add two links to the intermediary object (see below).
...
The next step is for you to create your intermediary object (see below). Before that, you need to create a field to link to with it.

## Create an Intermediary Object {#create-an-intermediary-object}

Use an intermediary object to connect a custom object to people or companies. In this example, it is used to connect courses in your course custom object to people or companies in your database.

>[!NOTE]
>
>You do not need to create an intermediary object for a one-to-many custom object structure.
...
1. The custom object information displays the content you entered. Notice that it is in a **[!UICONTROL Draft]** state.
   ...
   The next step is for you to [add link fields](/help/marketo/product-docs/administration/marketo-custom-objects/add-marketo-custom-object-link-fields.md) to connect your intermediary object to a person or company and a custom object.
