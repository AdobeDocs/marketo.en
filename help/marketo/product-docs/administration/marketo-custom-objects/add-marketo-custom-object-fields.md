...
After you have created a custom object, you need to add fields to it to meet your business needs.

Fields define the specific information used by a custom object. Link fields serve a specific purpose (connecting custom objects) and are covered in a [separate article](/help/marketo/product-docs/administration/marketo-custom-objects/add-marketo-custom-object-link-fields.md).
...
1. Click the **[!UICONTROL Fields]** tab, then **[!UICONTROL New Field]**.
   ...
   >[!NOTE]
   >
   >The three fields shown above are created automatically by Marketo when you create a custom object. Marketo manages these fields automatically and you cannot edit or delete them.
...
1. Enter a [!UICONTROL Display Name] and (optional) [!UICONTROL Description].
   ...
   >[!NOTE]
   >
   >The [!UICONTROL API Name] can be edited only until it is approved.

1. Choose an appropriate [!UICONTROL Data Type] from the list.
