...
##### 1. Under Admin, click Field Management. {#under-admin-click-field-management}

![](assets/image2014-9-19-9-3a56-3a22.png)

##### 2. Find and select the field you want to add an alias to. {#find-and-select-the-field-you-want-to-add-an-alias-to}

![](assets/fieldmanagement-findfield.png)

##### 3. Under Field Actions, click Edit Import Aliases. {#under-field-actions-click-edit-import-aliases}

![](assets/fieldmanageemnt-editimport.png) 

##### 4. Enter an Alias and click Save. {#enter-an-alias-and-click-save}
