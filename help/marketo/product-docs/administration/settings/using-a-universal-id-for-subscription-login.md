...
description: "How Universal ID lets you access multiple Marketo subscriptions with one login, switch between them, and how password policies and profile data work across subscriptions."
