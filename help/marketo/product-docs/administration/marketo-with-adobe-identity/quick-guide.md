---
description: "Quick reference with links to set up Marketo Engage with Adobe Identity, including System Admin setup, user management, API Only users, and sign-in."
title: Quick Guide
