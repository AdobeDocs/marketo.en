...
1. Choose to **[!UICONTROL Match with IAB List]**, **[!UICONTROL Match with Proximity Pattern]**, or both. Choose whether to [!UICONTROL log bot activity] _or_ [!UICONTROL filter bot activity]. Set the amount of seconds for **Duration Between Activities** from 0 to 3 seconds in length (default is 0). 
