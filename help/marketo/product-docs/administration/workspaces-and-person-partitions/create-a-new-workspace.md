...
>[!NOTE]
>
>To learn more about Workspace best practices, please contact [Marketo Professional Services](http://docs.marketo.com/cdn-cgi/l/email-protection#a2d1c7d0d4cbc1c7d1e2cfc3d0c9c7d6cd8cc1cdcf).
...
1. Enter a** Name**, and select the **Person Partition(s)** you want to use.&nbsp;Choose a **Primary Person Partition**.
   ...
   ##### If you enabled multiple branded domains, you must choose a primary branded domain. {#if-you-enabled-multiple-branded-domains-you-must-choose-a-primary-branded-domain}

   ![](assets/four-1.png)

   ##### Select the workspace&nbsp;language. {#select-the-workspace-language}
