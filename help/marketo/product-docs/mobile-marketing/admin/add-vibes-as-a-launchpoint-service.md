...
1. In My Marketo, click **[!UICONTROL Admin]** and then **[!UICONTROL LaunchPoint]**.

   ![](assets/image2016-7-27-9-3a31-3a17.png)

1. Click **[!UICONTROL New]** and **[!UICONTROL New Service]**.
...
1. Under Settings, enter your [!UICONTROL Vibes] username, password, and API Company Key. Click **[!UICONTROL Create]**.
