...
title: Use modules in the Email Designer
description: Learn how to access, insert, and customize pre-built modules in the Email Designer, including headers, heroes, and footers, for consistent email design.
