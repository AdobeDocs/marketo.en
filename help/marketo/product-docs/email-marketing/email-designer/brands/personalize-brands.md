...
1. If needed, click the "Edit" icon to update or delete one of your core brand value.
...
1. From the **[!UICONTROL Writing Style]** tab, click the **+** icon to add a guideline, exception or exclusion.
...
1. From the **[!UICONTROL Visual content]** tab, click the three dots icon to add a guideline, exclusion, or example. 
