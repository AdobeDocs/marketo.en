...
product: marketo
title: Brand checker
description: Learn how to create, validate, and manage on-brand content using the brand score checker.
...
Reviewing your brand score ensures consistency in tone, messaging, and visual identity across your email campaigns and serves as a quality check before your content goes live.

>[!AVAILABILITY]
>
>You must agree to the [user agreement](https://www.adobe.com/legal/licenses-terms/adobe-dx-gen-ai-user-guidelines.html){target="_blank"}{target="_blank"} before you can use the AI Assistant in Adobe Marketo Engage. For more information, contact your Adobe representative.

## Validate your content with brand alignment {#validate-content}

After your brand is [set up and published](/help/marketo/product-docs/email-marketing/email-designer/brands/manage-brands.md#create-brand-kit){target="_blank"}, assess your brand alignment score directly within your email campaign to ensure your content aligns with your brand guidelines.

1. In your email, click the **[!UICONTROL Brand Alignment]** icon.
    
    Your content automatically evaluates your [default brand](/help/marketo/product-docs/email-marketing/email-designer/brands/manage-brands.md#default-brand){target="_blank"}.
...
1. Click the ![Full screen icon for detailed insights](assets/icon-fullscreen.svg "Full screen") icon for a detailed view of your quality score.
