...
##### 1. While editing your program's email, click where you want the token to go, then click the Insert Token button. {#while-editing-your-programs-email-click-where-you-want-the-token-to-go-then-click-the-insert-token-button}
...
1. Select the Calendar File token and click **Insert**.
   ...
   ##### Your recipients will receive an email that looks like this. {#your-recipients-will-receive-an-email-that-looks-like-this}
