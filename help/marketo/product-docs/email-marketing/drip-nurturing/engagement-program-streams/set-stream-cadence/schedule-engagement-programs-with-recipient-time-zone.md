...
1. [Set your cadence settings](/help/marketo/product-docs/email-marketing/drip-nurturing/engagement-program-streams/set-stream-cadence.md) as you normally would, then check the **[!UICONTROL Recipient Time Zone]** box. Remember that your first cast must be at least 25 hours in the future. Click **[!UICONTROL Save]**.
