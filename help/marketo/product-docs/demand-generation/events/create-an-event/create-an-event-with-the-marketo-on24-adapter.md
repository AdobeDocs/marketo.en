...
* [Marketo Programs](../../../../product-docs/core-marketo-concepts/programs/creating-programs/understanding-programs.md) as well as Events, and the differences between them
* [Channels](../../../../product-docs/administration/tags/create-a-program-channel.md)
* [Local Assets](../../../../product-docs/core-marketo-concepts/programs/creating-programs/understanding-local-assets-in-a-program.md)
* [Child Campaigns](https://docs.marketo.com/x/IRCa) and [Program Statuses](../../../../product-docs/core-marketo-concepts/smart-campaigns/program-flow-actions/change-program-status.md)
