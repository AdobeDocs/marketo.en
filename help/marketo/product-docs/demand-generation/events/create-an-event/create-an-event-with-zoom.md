...
description: "Learn how to create an event with Zoom in Marketo. Set up the Zoom integration and sync meetings or webinars with your event program."
...
First create your webinar in [!DNL Zoom]. Certain settings in the creation of your [!DNL Zoom] are used by Marketo, and some are only used by [!DNL Zoom].
...
* **Registration** - Check this box to make registration required. You will use a Marketo form/landing page to capture registration information that will be pushed to [!DNL Zoom].

>[!NOTE]
>
>Marketo does not currently support recurring webinars. You must set up a single session between each Marketo Event and [!DNL Zoom] webinar.
...
1. Choose **[!UICONTROL Zoom]** from the **[!UICONTROL Event Partner]** List.

   ![](assets/eventsettings1.png)

1. Choose the [!DNL Zoom] account you want to associate your event with.
