...
1. Make your optional selections.
   ...
   >[!NOTE]
   >
   >* Selecting **Keep audience membership in sync** keeps the list up-to-date as it changes in your instance. Audience membership is updated when people are added to or removed from the static list.
   >
