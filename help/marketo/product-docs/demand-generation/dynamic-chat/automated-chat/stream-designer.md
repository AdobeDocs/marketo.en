...
<table>
 ...
 <tr>
  ...
  <td>This is the only card the visitors won't see. It is for you to determine at which point a goal is achieved within the specific chat (ex: if collecting the visitor's email is your goal, place the Goal card immediately after Info Capture in the stream).</td>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <li>Visitors will be routed to an agent as soon as they reach this card in the stream, so it is recommended to precede this card with a question card asking visitors if they'd like to chat with a live agent.</li></td>
 </tr>
 <tr>
...
1. When you are ready to activate your Dialogue, click **[!UICONTROL Publish]**.
