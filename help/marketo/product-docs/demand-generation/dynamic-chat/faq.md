...
**I do not seem to have access to Dynamic Chat. How can I get it?**

Contact your Marketo Engage Admin and verify they have [added you as a user](/help/marketo/product-docs/demand-generation/dynamic-chat/setup-and-configuration/add-or-remove-chat-users.md#add-a-chat-user){target="_blank"} in the Adobe Admin Console.
...
Dynamic Chat does not support AI/NLP functionality.
...
When you have reached 90% of your engaged conversation limit, Dynamic Chat admins will receive an email notification and all users will see a banner notification in Dynamic Chat.
...
For customers on the Select package, this will count as two separate engagements: one for the Dialogue engagement and one for the live chat engagement. For customers on the Prime package, live chat engagements are not counted separately, so this would only count as one engagement.
...
**Why does the chatbot not come back after I have finished a conversation?**
...
This most likely indicates that you have not been added as a Dynamic Chat user in the Adobe Admin Console. Contact either a system administrator for your Adobe org or a product administrator for Dynamic Chat to request access to Dynamic Chat.
...
**My calendar is connected in Dynamic Chat and I am included in the routing rules, so why am I not getting any meetings?**

This most likely indicates that your calendar connection needs to be re-authenticated. This most often occurs when you change your password for your calendar provider and Dynamic Chat loses connection. Go to the Agent Settings page in Dynamic Chat and click "Reauthenticate calendar."
