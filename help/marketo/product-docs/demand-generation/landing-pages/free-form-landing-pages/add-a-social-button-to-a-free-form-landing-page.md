...
description: Learn how to add a social button to a free-form landing page in Marketo. Add share or follow buttons to your page.
...
1. Select **[!UICONTROL Social Buttons (with Analytics)]**.
   ...
   After your landing page is active, you can view the activity generated by your social button (with Analytics) on the Social Dashboard.
...
1. Name your social button, select **[!UICONTROL None]** from **[!UICONTROL Clone From]**, and click **[!UICONTROL Insert]**.
 ...
 1. Publish the landing page [to Facebook](/help/marketo/product-docs/demand-generation/facebook/publish-landing-pages-to-facebook.md) and put the social button on your website.

You have added a social button to your landing page. Approve the landing page when you are ready.
