...
1. If you chose **Add Static content** above, edit the title, caption, and description, and upload a custom image (from your [**Marketo Images and Files**](/help/marketo/product-docs/demand-generation/images-and-files/add-images-and-files-to-marketo.md)).
...
1. If you chose **Add Static content** above, edit the title and description, and upload a custom image (from your [**Marketo Images and Files**](/help/marketo/product-docs/demand-generation/images-and-files/add-images-and-files-to-marketo.md)).
...
>[!MORELIKETHIS]
>
>Next, you can click **Finish** > **Approve and Close** and put your social app on a landing page. You can also configure [person capture](/help/marketo/product-docs/demand-generation/social/configuring-social-actions/configure-person-capture-for-a-social-app.md) or the [re-share prompt](/help/marketo/product-docs/demand-generation/social/configuring-social-actions/configure-re-share-email-and-prompt-for-a-social-app.md).
