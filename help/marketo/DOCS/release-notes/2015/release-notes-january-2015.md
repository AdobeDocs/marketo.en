...
[Email Scripting Custom Object Support](#email-scripting-custom-object-support)  
...
[Named Account List Module](#named-account-list-module)  
[Updated RTP Tag Options](#updated-rtp-tag-options)
...
Make suggestions for future photos by emailing [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#f4849c9b809b87b49995869f91809bda979b99).
...
##### [Named Account List Module](../../product-docs/web-personalization/account-based-web-marketing/create-a-new-account-list.md) {#named-account-list-module}
...
[RTP Tag](../../product-docs/web-personalization/getting-started-rtp/rtp-tag-implementation.md) options under Account Settings have been updated to include:
