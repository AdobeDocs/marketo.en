...
[Marketo-Vibes SMS LaunchPoint Integration](#marketo-vibes-sms-launchpoint-integration)  
...
#### [Account Based Marketing](../../product-docs/account-based-marketing.md) {#account-based-marketing}
...
#### [Audit Trail](../../product-docs/administration/audit-trail.md) {#audit-trail}
...
#### [Marketo-Vibes SMS LaunchPoint Integration](../../product-docs/mobile-marketing/vibes-sms-messages.md) {#marketo-vibes-sms-launchpoint-integration}
...
#### [Email 2.0 Enhancements](http://docs.marketo.com/display/docs/assets/email-editor-v2.0-overview) {#email-enhancements}
...
#### [Multiple Branding Domains](../../product-docs/administration/email-setup/add-multiple-branding-domains.md) {#multiple-branding-domains}
...
#### [API Support for Email Editor 2.0](http://developers.marketo.com/documentation/asset-api/) {#api-support-for-email-editor}
