...
Get Set Up and Add a Person - Marketo Docs - Product Documentation
...
#### Step 1: Log In to Marketo {#getsetupandaddaperson-step1-logintomarketo}

1. [Log in to Marketo](http://app.marketo.com) using the credentials you received by email.

   ![](assets/one.png)

   #### Step 2: Create a Learning Folder {#getsetupandaddaperson-step2-createalearningfolder}
...
1. You'll see the new Learning folder appear in the left menu.
   ...
   #### Step 3: Add Yourself as a Person {#getsetupandaddaperson-step3-addyourselfasaperson}
...
#### Set Up Complete {#getsetupandaddaperson-setupcomplete}
