...
Release Notes: January 2015 - Marketo Docs - Product Documentation
...
[Marketing Automation Updates](#releasenotes-january2015-marketingautomationupdates)  
[Mobile Friendly Landing Pages](#releasenotes-january2015-mobilefriendlylandingpages)  
[New ReST API Calls](#releasenotes-january2015-newrestapicalls)  
[Email Scripting Custom Object Support](#releasenotes-january2015-emailscriptingcustomobjectsupport)  
[Real-Time Personalization](#releasenotes-january2015-real-timepersonalization)  
[Personalized Remarketing for Google and Facebook](#releasenotes-january2015-personalizedremarketingforgoogleandfacebook)  
[Named Account List Module](#releasenotes-january2015-namedaccountlistmodule)  
[Updated RTP Tag Options](#releasenotes-january2015-updatedrtptagoptions)
...
Make suggestions for future photos by emailing [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#7e0e16110a110d3e131f0c151b0a11501d1113).

#### Mobile Friendly Landing Pages {#releasenotes-january2015-mobilefriendlylandingpages}

You can now [build mobile views for landing pages](../../../welcome-to-marketo-docs/product-docs/demand-generation/landing-pages/free-form-landing-pages/add-a-mobile-view-for-your-free-form-landing-page.md) from within the landing page editor. Deliver your message effectively regardless of device and increase engagement by tailoring your content for easy consumption on-the-go. This feature will rollout gradually throughout the week following the release. 
...
Remarketing shows ads to people who have visited your website. You can now personalize your remarketing campaigns on [Google](../../../welcome-to-marketo-docs/product-docs/web-personalization/website-retargeting/personalized-remarketing-in-google.md) and [Facebook](../../../welcome-to-marketo-docs/product-docs/web-personalization/website-retargeting/personalized-remarketing-in-facebook.md)using data from Real-Time Personalization. Remarket to audiences from different industries, named account lists, company sizes or any data from known leads.

##### [Named Account List Module](../../../welcome-to-marketo-docs/product-docs/web-personalization/account-based-web-marketing/create-a-new-account-list.md) {#releasenotes-january2015-namedaccountlistmodule}
...
[RTP Tag](../../../welcome-to-marketo-docs/product-docs/web-personalization/getting-started-(rtp)/rtp-tag-implementation.md) options under Account Settings have been updated to include:
...
For best performance, it is recommended to place the tag at the top of the header in your web page after <head>. All tags allow for use of the [RTP API](http://developers.marketo.com/documentation/websites/rtp-js-api/). For information on how to deploy the RTP Tag see [here](../../../welcome-to-marketo-docs/product-docs/web-personalization/getting-started-(rtp)/rtp-tag-implementation/deploy-the-rtp-javascript.md).
