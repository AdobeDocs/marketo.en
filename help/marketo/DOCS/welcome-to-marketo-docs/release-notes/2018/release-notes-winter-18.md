...
Release Notes: Winter '18 - Marketo Docs - Product Documentation
...
[Campaign Performance and Throughput Enhancements](#releasenotes-winter'18-campaignperformanceandthroughputenhancements)  
[Enhancements to Marketo’s Salesforce CRM Integration](#releasenotes-winter'18-enhancementstomarketo’ssalesforcecrmintegration)  
[Marketo Performance Insights](#releasenotes-winter'18-marketoperformanceinsights)  
[Account Based Marketing Enhancements](#releasenotes-winter'18-accountbasedmarketingenhancements)  
[Email Marketing](#releasenotes-winter'18-emailmarketing)  
[Ad Network Integrations](#releasenotes-winter'18-adnetworkintegrations)  
[Web Personalization](#releasenotes-winter'18-webpersonalization)  
[ContentAI](#releasenotes-winter'18-contentai)  
[Integration](#releasenotes-winter'18-integration)  
[ToutApp](#releasenotes-winter'18-toutapp)
...
* [Marketo Admin notifications](../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/miscellaneous/understanding-notifications/notification-types.md) for certain CRM sync failures (credentials expired, API limits reached, etc.)

* [Ability to turn off email notifications](../../../welcome-to-marketo-docs/product-docs/crm-sync/salesforce-sync/setup/optional-steps/turn-off-email-notifications-to-lead-owner.md) to Lead Owners upon lead assignment

These improvements will roll out over 2018.

#### [Marketo Performance Insights](../../../welcome-to-marketo-docs/product-docs/reporting/performance-insights/performance-insights-overview.md) {#releasenotes-winter'18-marketoperformanceinsights}
...
** [Dynamic Email Script](../../../welcome-to-marketo-docs/product-docs/email-marketing/general/using-tokens/create-an-email-script-token.md)**
...
* ** [Monthly Nurture Cadence](../../../welcome-to-marketo-docs/product-docs/email-marketing/email-programs/email-program-actions/scheduling-with-recipient-time-zone/schedule-email-programs-with-recipient-time-zone.md)**:** **We've added the ability to schedule nurture programs on a monthly cadence.

* ** [Stop Delivery](../../../welcome-to-marketo-docs/product-docs/email-marketing/email-programs/email-program-actions/scheduling-with-recipient-time-zone/abort-delivery-of-email-programs-scheduled-with-recipient-time-zone.md)**: You can now stop any remaining sends mid-run.

#### Ad Network Integrations {#releasenotes-winter'18-adnetworkintegrations}

** [Google Customer Match Integration](../../../welcome-to-marketo-docs/product-docs/demand-generation/ad-network-integrations/add-google-customer-match-as-a-launchpoint-service.md)**
...
** [LinkedIn Matched Audiences API Enhancement](../../../welcome-to-marketo-docs/product-docs/demand-generation/ad-network-integrations/add-linkedin-matched-audiences-as-a-launchpoint-service.md)**
...
** [Create a Web Segment Using Static Lists](../../../welcome-to-marketo-docs/product-docs/web-personalization/using-web-segments/create-a-segment-using-a-static-list.md)**
...
#### Content`<sup>AI</sup>` {#releasenotes-winter'18-contentai}
