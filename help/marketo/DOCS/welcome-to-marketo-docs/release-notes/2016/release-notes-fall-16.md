...
Release Notes: Fall '16 - Marketo Docs - Product Documentation
...
[Predictive Content in Email](#releasenotes-fall'16-predictivecontentinemail)  
[Facebook Offline Conversions](#releasenotes-fall'16-facebookofflineconversions)  
[Universal ID](#releasenotes-fall'16-universalid)  
[Marketo Account Based Marketing Enhancements](#releasenotes-fall'16-marketoaccountbasedmarketingenhancements)  
[Audit Trail Enhancements](#releasenotes-fall'16-audittrailenhancements)  
[New Permissions](#releasenotes-fall'16-newpermissions)  
[Sound for Mobile Push Notifications](#releasenotes-fall'16-soundformobilepushnotifications)  
[Sales Insight Compatible with Salesforce Encryption](#releasenotes-fall'16-salesinsightcompatiblewithsalesforceencryption)  
[Named Accounts APIs](#releasenotes-fall'16-namedaccountsapis)  
[Email Editor v2.0 API Support](#releasenotes-fall'16-emaileditorv2-0apisupport)  
[Changes to Marketo Salesforce Sync](#releasenotes-fall'16-changestomarketosalesforcesync)

#### [Predictive Content in Email](../../../welcome-to-marketo-docs/product-docs/predictive-content.md)  {#releasenotes-fall'16-predictivecontentinemail}
...
#### [Facebook Offline Conversions](../../../welcome-to-marketo-docs/product-docs/demand-generation/facebook/understanding-facebook-offline-conversions.md)  {#releasenotes-fall'16-facebookofflineconversions}
...
#### [Universal ID](../../../welcome-to-marketo-docs/product-docs/administration/settings/using-a-universal-id-for-subscription-login.md) {#releasenotes-fall'16-universalid}
...
#### [Marketo Account Based Marketing Enhancements](../../../welcome-to-marketo-docs/product-docs/account-based-marketing/setup-abm-.md) {#releasenotes-fall'16-marketoaccountbasedmarketingenhancements}
...
#### [Audit Trail Enhancements](../../../welcome-to-marketo-docs/product-docs/administration/audit-trail/change-details-in-audit-trail.md) {#releasenotes-fall'16-audittrailenhancements}
...
#### [New Permissions](../../../welcome-to-marketo-docs/product-docs/administration/users-and-roles/managing-user-roles-and-permissions/descriptions-of-role-permissions.md) {#releasenotes-fall'16-newpermissions}
...
#### [Sound for Mobile Push Notifications](../../../welcome-to-marketo-docs/product-docs/mobile-marketing/push-notifications/configure-mobile-push-notification.md) {#releasenotes-fall'16-soundformobilepushnotifications}
...
#### [Sales Insight Compatible with Salesforce Encryption](../../../welcome-to-marketo-docs/product-docs/marketo-sales-insight/msi-for-salesforce/installation/install-marketo-sales-insight-package-in-salesforce-appexchange.md) {#releasenotes-fall'16-salesinsightcompatiblewithsalesforceencryption}
...
#### [Named Accounts APIs](http://developers.marketo.com/rest-api/lead-database/named-accounts/) {#releasenotes-fall'16-namedaccountsapis}
...
#### [Email Editor v2.0 API Support](http://developers.marketo.com/rest-api/assets/emails/) {#releasenotes-fall'16-emaileditorv2-0apisupport}

Manage variables and modules for emails in v2.0 format using the Marketo REST API.

#### [Changes to Marketo Salesforce Sync](https://nation.marketo.com/docs/DOC-3840) {#releasenotes-fall'16-changestomarketosalesforcesync}
