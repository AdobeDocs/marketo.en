...
1. Click **Admin **and then **Smart Campaign**.
   ...
   ##### Click Edit. {#enablepersonrestrictionsforsmartcampaigns-clickedit}
   ...
   ##### Enter a limit and then click Save. {#enablepersonrestrictionsforsmartcampaigns-enteralimitandthenclicksave}
