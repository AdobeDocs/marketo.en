...
1. Select **Mobile Apps**.
   ...
   ##### Select the desired mobile app. {#configuremobileappandroidpushaccess-selectthedesiredmobileapp}
...
1. Under **Push Access Type**, select **Android** and click **Configure.**
   ...
   ##### Enter your Server API Key and Project Number. Click Save. {#configuremobileappandroidpushaccess-enteryourserverapikeyandprojectnumber-clicksave}
