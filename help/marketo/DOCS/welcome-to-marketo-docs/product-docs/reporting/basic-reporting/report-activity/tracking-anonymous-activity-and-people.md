...
1. An anonymous activity is created when someone:
   ...
   ##### An anonymous activity is merged into a new or existing person when someone: {#trackinganonymousactivityandpeople-ananonymousactivityismergedintoaneworexistingpersonwhensomeone}
