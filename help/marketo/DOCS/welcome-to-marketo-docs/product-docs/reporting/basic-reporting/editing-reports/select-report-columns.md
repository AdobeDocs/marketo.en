...
Select Report Columns - Marketo Docs - Product Documentation
...
1. Click the **Report** tab, then click any column heading and select **Columns**, and then choose the columns to include.
   ...
   Do more with reports! See [Basic Reporting](../../../../../welcome-to-marketo-docs/product-docs/reporting/basic-reporting.md).
