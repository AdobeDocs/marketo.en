...
Change Engagement Program Stream - Marketo Docs - Product Documentation
...
#### Overview {#changeengagementprogramstream-overview}

Normally you would use [stream transition rules](../../../../../welcome-to-marketo-docs/product-docs/email-marketing/drip-nurturing/engagement-program-streams/transition-people-between-engagement-streams.md) to achieve this, but if you want to manually move people from one stream to another, this is the flow step to use.

![](assets/image2014-9-22-14-3a52-3a14.png)

#### Usage {#changeengagementprogramstream-usage}
