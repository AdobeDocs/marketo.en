...
Deactivate a Trigger Smart Campaign | Schedule Tab - Marketo Docs - Product Documentation

If you have an old trigger campaign that you need to deactivate, follow these steps:

##### 1. Find and select your active trigger campaign. {#deactivateatriggersmartcampaign|scheduletab-findandselectyouractivetriggercampaign}

![](assets/selectprogram-hands.png)

##### 2. Under the Schedule tab, click Deactivate. {#deactivateatriggersmartcampaign|scheduletab-underthescheduletab-clickdeactivate}

![](assets/deactivateprogram-hands.png)

##### 3. Confirm by clicking Deactivate. {#deactivateatriggersmartcampaign|scheduletab-confirmbyclickingdeactivate}
