...
Understanding Static Lists - Marketo Docs - Product Documentation
...
[Ways to Add/Remove People from a List](#understandingstaticlists-waystoadd-removepeoplefromalist)  
[Some Uses of a Static List](#understandingstaticlists-someusesofastaticlist)
...
1. Smart campaign flow step ([Add to List](../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/add-to-list.md), [Remove from List](../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/remove-from-list.md))

1. [Single action flow step](../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/run-a-single-flow-step-from-a-smart-list.md)
1. Dragging people into a list in the tree
1. [List import](../../../../../welcome-to-marketo-docs/getting-started/quick-wins/import-a-list-of-people.md)
