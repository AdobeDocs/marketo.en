...
>**Prerequisites**
>
>Finding and merging duplicates will involve the use of [built-in / system smart lists](../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/use-built-in-system-smart-lists.md).

### What's in this article? {#what-s-in-this-article}

[Find Duplicates](#findandmergeduplicatepeople-findduplicates)  
[Merge People Manually](#findandmergeduplicatepeople-mergepeoplemanually)  
[Effect in Salesforce](#findandmergeduplicatepeople-effectinsalesforce)  
[Bulk Merging](#findandmergeduplicatepeople-bulkmerging)
...
1. Select the **Possible** **Duplicates** system smart list and click on the **People** tab.
   ...
   ##### Select the duplicates by holding Ctrl/Cmd and clicking, then click Merge People. {#findandmergeduplicatepeople-selecttheduplicatesbyholdingctrl-cmdandclicking-thenclickmergepeople}
