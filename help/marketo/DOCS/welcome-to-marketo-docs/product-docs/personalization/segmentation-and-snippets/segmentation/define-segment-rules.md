...
1. Go to **Segmentation Actions**. Click **Approve**.
   ...
   >
   >
   >If you get an error message during approval and require assistance in reducing the complexity of your segmentation, please contact [Marketo Support](http://docs.marketo.com/cdn-cgi/l/email-protection#01727471716e7375416c60736a64756e2f626e6c).
