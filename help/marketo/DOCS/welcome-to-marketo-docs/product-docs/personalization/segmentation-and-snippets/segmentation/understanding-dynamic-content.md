...
[Snippets](../../../../../welcome-to-marketo-docs/product-docs/personalization/segmentation-and-snippets/snippets/create-a-snippet.md) are a useful tool in Marketo. Create it once, and use it in multiple places! If you update the snippet, all the assets (landing pages or emails) using the snippet will be automatically updated.
