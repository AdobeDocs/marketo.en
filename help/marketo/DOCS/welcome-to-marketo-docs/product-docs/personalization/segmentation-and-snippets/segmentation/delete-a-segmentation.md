...
1. Remove all associations and then in **Segmentation Actions** click **Unapprove**.
   ...
   ##### Once unapproved, click on Segmentation Actions and Delete the segmentation. {#deleteasegmentation-onceunapproved-clickonsegmentationactionsanddeletethesegmentation}
