...
1. In the Segmentation click **Segmentation Actions**, and then **Approve**.
   ...
   ##### Once approved, the Status changes from Approving to Approved. {#approveasegmentation-onceapproved-thestatuschangesfromapprovingtoapproved}
...
>
>If you get an error message during approval and require assistance in reducing the complexity of your segmentation, please contact [Marketo Support](http://docs.marketo.com/cdn-cgi/l/email-protection#6d1e181d1d021f192d000c1f06081902430e0200).
