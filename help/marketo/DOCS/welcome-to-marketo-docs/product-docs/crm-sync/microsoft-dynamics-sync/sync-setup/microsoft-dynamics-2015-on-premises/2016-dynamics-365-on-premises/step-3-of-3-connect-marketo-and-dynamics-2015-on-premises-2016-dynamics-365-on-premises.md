...
1. Enter the **Username**, **Password **a Microsoft Dynamics **URL**, and an *optional*** Client Id. **Click **Save** when done.
   ...
   >[!NOTE]
   >
   >The Username in Marketo must match the User Name for the sync user in CRM. The format can be [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#0f7a7c6a7d4f6b60626e6661216c6062) or DOMAIN\user.
