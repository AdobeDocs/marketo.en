...
1. Enter the **Username**, **Password** and CRM **URL **then click **Save**.
   ...
   >[!NOTE]
   >
   >The Username in Marketo must match the User Name for the sync user in CRM. The format can be [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#92e7e1f7e0d2f6fdfff3fbfcbcf1fdff) or DOMAIN\user.
