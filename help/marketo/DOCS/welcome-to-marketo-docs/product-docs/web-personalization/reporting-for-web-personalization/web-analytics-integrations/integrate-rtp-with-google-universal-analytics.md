...
Integrate RTP with Google Universal Analytics - Marketo Docs - Product Documentation

### What's in this article? {#what-s-in-this-article}

[Intro](#integratertpwithgoogleuniversalanalytics-intro)  
[Set up Custom Dimensions in GUA](#integratertpwithgoogleuniversalanalytics-setupcustomdimensionsingua)  
[Activate the GUA integration in your RTP account](#integratertpwithgoogleuniversalanalytics-activatetheguaintegrationinyourrtpaccount)  
[Remove Old Dashboards in Google Analytics](#integratertpwithgoogleuniversalanalytics-removeolddashboardsingoogleanalytics)
