...
Email Deliverability Power Pack: How to Import a Seedlist - Marketo Docs - Product Documentation
...
#### Import a Seedlist {#emaildeliverabilitypowerpack-howtoimportaseedlist-importaseedlist}
...
1. After export, the list will appear as a .txt file in your browser’s downloads folder. Retrieve it, and [import](../../../../welcome-to-marketo-docs/getting-started/quick-wins/import-a-list-of-people.md) it into your Marketo instance as a static list.
   ...
   #### Acquiring New Seedlists {#emaildeliverabilitypowerpack-howtoimportaseedlist-acquiringnewseedlists}
