...
Transition People Between Engagement Streams - Marketo Docs - Product Documentation

Engagement programs can have more than one stream. If you [add a stream](../../../../../welcome-to-marketo-docs/product-docs/email-marketing/drip-nurturing/creating-an-engagement-program/add-a-stream.md), you'll want to define a way for people to move from one stream to another. These are called **transition rules.**
...
1. Click **Transition Rules** for the stream you want to pull into from other streams, then click **Edit Transition Rules. **
   ...
   ##### Once the transition rule window opens, find and drag in your trigger of choice. In this case, we want to move people into Mid Stage when it is added to an opportunity. {#transitionpeoplebetweenengagementstreams-oncethetransitionrulewindowopens-findanddraginyourtriggerofchoice-inthiscase-wewanttomovepeopleintomidstagewhenitisaddedtoanopportunity}
