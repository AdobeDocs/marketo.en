...
Remove a Member from an Engagement Program - Marketo Docs - Product Documentation
...
#### Flow Step {#removeamemberfromanengagementprogram-flowstep}
...
1. Drag in the **Change Program Status** flow step.
   ...
   Groovy. All the members you've defined in the [smart list](../../../../../welcome-to-marketo-docs/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/create-a-smart-list.md) will no longer be in this engagement program.

   #### Pause People  {#removeamemberfromanengagementprogram-pausepeople}
