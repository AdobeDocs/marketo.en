...
##### 1. Select the Send Test date. {#schedulethea-btest-selectthesendtestdate}
...
1. Do the same thing for **Send Winner**. Enter notification recipients (optional) and click **Next**.
   ...
   ##### Super! You're done, just review the summary and click Close. {#schedulethea-btest-super-you'redone-justreviewthesummaryandclickclose}
