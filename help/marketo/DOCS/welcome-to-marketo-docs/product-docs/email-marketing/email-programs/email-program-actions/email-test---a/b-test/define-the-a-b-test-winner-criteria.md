...
[Winner Criteria](#definethea-btestwinnercriteria-winnercriteria)  
[Declare Winner](#definethea-btestwinnercriteria-declarewinner)
...
1. The default **Winner Criteria** options are listed first.
   ...
   >[!TIP]
   >
   >If you pick Engagement Score the test will need to run for at least 24 hours. Learn more about [understanding the engagement score](../../../../../../../welcome-to-marketo-docs/product-docs/email-marketing/drip-nurturing/reports-and-notifications/understanding-the-engagement-score.md).

   ##### You can also customize your criteria by selecting Custom Conversion and clicking Edit. {#definethea-btestwinnercriteria-youcanalsocustomizeyourcriteriabyselectingcustomconversionandclickingedit}
   ...
   ##### A window will pop open. Find the trigger of your choice and drag it into the canvas. {#definethea-btestwinnercriteria-awindowwillpopopen-findthetriggerofyourchoiceanddragitintothecanvas}
   ...
   ##### Define the trigger. {#definethea-btestwinnercriteria-definethetrigger}
   ...
   ##### Click Close. {#definethea-btestwinnercriteria-clickclose}
