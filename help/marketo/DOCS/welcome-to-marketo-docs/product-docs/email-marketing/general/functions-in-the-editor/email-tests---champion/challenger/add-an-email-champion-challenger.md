...
>[!CAUTION]
>
>Champion/Challenger emails only work with trigger campaigns and engagement program streams. For batch mailings, use the email program's [A/B testing functionality](../../../../../../../welcome-to-marketo-docs/product-docs/email-marketing/email-programs/email-program-actions/email-test---a/b-test/add-an-a-b-test.md).
...
1. Find and select an email.
   ...
   >
   >
   >For one-time mail blasts, learn more about [email programs](../../../../../../../welcome-to-marketo-docs/product-docs/email-marketing/email-programs.md).
