...
Understanding Predictive Content - Marketo Docs - Product Documentation
...
After you [approve a title for predictive content](../../../../welcome-to-marketo-docs/product-docs/predictive-content/working-with-all-content/approve-a-title-for-predictive-content.md), you work on it here. 

### What's in this article? {#what-s-in-this-article}

[Filtering Content](#understandingpredictivecontent-filteringcontent)  
[Display Analytics by Date](#understandingpredictivecontent-displayanalyticsbydate)  
[View Table Data for Predictive Content](#understandingpredictivecontent-viewtabledataforpredictivecontent)  
...
##### Category {#understandingpredictivecontent-category}
...
##### Enabled Source {#understandingpredictivecontent-enabledsource}
...
##### Analytics by Source  
{#understandingpredictivecontent-analyticsbysource}
...
In the table, you can view which sources are enabled for predictive content, from left to right: Recommendation Bar, email, and Rich Media. Enabled sources are shown in green. You enable these when you [edit the content](edit-predictive-content.md).
...
>* [Edit Predictive Content](edit-predictive-content.md)
>
