...
1. Click the **Categories** box to select/add [categories you've already set up](../../../../../welcome-to-marketo-docs/product-docs/predictive-content/getting-started-(predictive-content-and-content-ai)/set-up-categories.md) (optional).
