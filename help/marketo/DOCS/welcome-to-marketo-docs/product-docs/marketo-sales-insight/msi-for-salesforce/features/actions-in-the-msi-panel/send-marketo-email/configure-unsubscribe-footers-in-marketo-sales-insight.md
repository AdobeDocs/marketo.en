...
Configure Unsubscribe Footers in Marketo Sales Insight - Marketo Docs - Product Documentation
...
1. Click **Sales Insight, **then **Edit Settings**.
   ...
   ##### Make the changes you want, then click Save. {#configureunsubscribefootersinmarketosalesinsight-makethechangesyouwant-thenclicksave}
...
>**Deep Dive**
>
>Learn more about [Marketo Sales Insight](../../../../../../../welcome-to-marketo-docs/product-docs/marketo-sales-insight.md).
