...
1. Go to **Marketing Activities**.
   ...
   ##### Select your Landing Page, then click Edit Draft. {#usedynamiccontentinafree-formlandingpage-selectyourlandingpage-thenclickeditdraft}

   ![](assets/landingpageeditdraft-1.jpg)

   ##### Click Segment By. {#usedynamiccontentinafree-formlandingpage-clicksegmentby}

   ![](assets/image2014-9-17-12-3a8-3a46.png)  

   ##### Enter the Segmentation name and click Save. {#usedynamiccontentinafree-formlandingpage-enterthesegmentationnameandclicksave}

   ![](assets/image2014-9-17-12-3a8-3a53.png)  

   ##### Your segmentation and its segments appear under Dynamic on the right. {#usedynamiccontentinafree-formlandingpage-yoursegmentationanditssegmentsappearunderdynamicontheright}
