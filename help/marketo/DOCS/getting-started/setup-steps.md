...
1. Set Up Your Authorized Support Contacts
   ...
   ##### Go to the [Marketo Support Portal](http://support.marketo.com/). {#go-to-the-marketo-support-portal}

   ##### Click the pencil icon and select My Cases. {#click-the-pencil-icon-and-select-my-cases}

   ![](assets/support.png)

   ##### Select Manage Authorized Contacts. {#select-manage-authorized-contacts}
   ...
   {#search-for-your-name-or-the-name-of-the-person-you-wish-to-add-as-an-authorized-contact}

   ##### Select the Is Authorized box next to their name. {#select-the-is-authorized-box-next-to-their-name}
...
1. Customize Your Landing Page URLs with a CNAME
   ...
   ##### Click Landing Pages. {#click-landing-pages}
...
1. Complete Your Marketo Setup After IT Finishes
   ...
   ##### Go to the Admin area to Add Your Landing Page CNAME {#go-to-the-admin-area-to-add-your-landing-page-cname}
   ...
   ##### Scroll down and click Edit. {#scroll-down-and-click-edit}
...
1. Integrate Your CRM
    ...
    * [Integrate Marketo with Salesforce.com](../product-docs/crm-sync/salesforce-sync.md)
    * [Integrate Marketo with Microsoft Dynamics](../product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-2015-on-premises-2016-dynamics-365-on-premises.md)
