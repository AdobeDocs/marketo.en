...
##### 1. In your smart campaign, click the Schedule tab and then Edit Settings. {#in-your-smart-campaign-click-the-schedule-tab-and-then-edit-settings}

![](assets/programeditsettings-hands-1.png)  

##### 2. Check the Block non-operational emails checkbox, and then click Save. {#check-the-block-non-operational-emails-checkbox-and-then-click-save}
