...
##### Trait Usage for Adobe Audience Manager Customers {#trait-usage-for-adobe-audience-manager-customers}
...
##### Why is the list size in Marketo different than the one in Adobe? {#why-is-the-list-size-in-marketo-different-than-the-one-in-adobe}
...
##### How does the cookie sync work? {#how-does-the-cookie-sync-work}
