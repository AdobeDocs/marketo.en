...
##### 2.&nbsp;In the Branding Domains table, select the current generic domain and click Edit to change it to your company's branded domain.  {#in-the-branding-domains-table-select-the-current-generic-domain-and-click-edit-to-change-it-to-your-companys-branded-domain}
...
##### 3.&nbsp;Enter the name of your default domain and click Next.  {#enter-the-name-of-your-default-domain-and-click-next}
