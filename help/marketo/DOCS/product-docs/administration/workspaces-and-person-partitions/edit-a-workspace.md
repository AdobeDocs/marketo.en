...
1. You can select a different lead partition and choose a different primary person partition from the drop-down.
   ...
   ##### If you enabled multiple branded domains, you can change to a different primary branded domain. Click Save. {#if-you-enabled-multiple-branded-domains-you-can-change-to-a-different-primary-branded-domain-click-save}
