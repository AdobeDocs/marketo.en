...
1. Define the filter(s).
   ...
   >
   >
   >Check out [smart lists and static lists](../../../../product-docs/core-marketo-concepts/smart-lists-and-static-lists.md) to learn more about using and defining filters.
