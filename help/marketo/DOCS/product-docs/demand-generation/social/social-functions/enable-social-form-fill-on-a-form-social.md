...
Enable Social Form Fill on a Form(Social) - Marketo Docs - Product Documentation
...
1. Check the social network buttons you want to include. 
   ...
   >[!TIP]
   >
   >Take a look at what [data Marketo will capture](manage-social-profile-data.md) if people use the social buttons.
