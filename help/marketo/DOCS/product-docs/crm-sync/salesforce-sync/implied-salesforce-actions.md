...
##### These rules will apply *when the person is not currently in [Salesforce.com](http://Salesforce.com)* as a contact or lead. {#these-rules-will-apply-when-the-person-is-not-currently-in-salesforce-com-as-a-contact-or-lead}
