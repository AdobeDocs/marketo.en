...
<tbody>
  ...
  <tr>
    ...
    <ul><li>Remember that maintaining <a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/core-marketo-concepts/programs/working-with-programs/using-period-costs-in-a-program">Period Costs</a> is critical to leveraging the Program Performance Report.</li>
