...
Below are the old icons from Marketo Classic. The new icon glossary can be [found here](/help/marketo/product-docs/marketo-engage-next-generation-experience/new-icon-glossary.md).
