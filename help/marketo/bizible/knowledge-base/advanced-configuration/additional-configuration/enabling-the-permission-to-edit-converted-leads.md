...
##### 1. Go to Setup and expand the Manage Users grouping to select Profiles. {#enablingthepermissiontoeditconvertedleads-gotosetupandexpandthemanageusersgroupingtoselectprofiles.}

![](assets/1-2.png)

##### 2. Select the Profile of the user we are connected through. {#enablingthepermissiontoeditconvertedleads-selecttheprofileoftheuserweareconnectedthrough.}

##### 3. Search for the permission to View and Edit Converted Leads. {#enablingthepermissiontoeditconvertedleads-searchforthepermissiontoviewandeditconvertedleads.}

![](assets/2-1.png)

##### 4. Check the box to enable the permission to view and edit converted leads. {#enablingthepermissiontoeditconvertedleads-checktheboxtoenablethepermissiontoviewandeditconvertedleads.}
