...
#### Scenario 1 – HTML form with an AJAX submit {#ajaxformhandling-scenario1–htmlformwithanajaxsubmit}
...
#### Scenario 2 – Lead information collected in a non-HTML form {#ajaxformhandling-scenario2–leadinformationcollectedinanon-htmlform}
...
#### Scenario 3 - Report user information from the thank-you page {#ajaxformhandling-scenario3-reportuserinformationfromthethank-youpage}
