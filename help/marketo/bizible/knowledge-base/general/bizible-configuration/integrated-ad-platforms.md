...
[How to Connect Ad Platforms](#integratedadplatforms-howtoconnectadplatforms)  
[Google AdWords](#integratedadplatforms-googleadwords)  
[What Happens When Auto-tagging is Enabled](#integratedadplatforms-whathappenswhenauto-taggingisenabled)  
[How to Enable Bizible Auto-tagging for Adwords](#integratedadplatforms-howtoenablebizibleauto-taggingforadwords)  
[How to Set up a Tracking Template in AdWords with Bizible Parameters](#integratedadplatforms-howtosetupatrackingtemplateinadwordswithbizibleparameters)  
[How to Automatically Generate UTM Tags for Google AdWords](#integratedadplatforms-howtoautomaticallygenerateutmtagsforgoogleadwords)  
[Bing Ads](#integratedadplatforms-bingads)  
[Facebook Ads](#integratedadplatforms-facebookads)  
[LinkedIn Sponsored Content](#integratedadplatforms-linkedinsponsoredcontent)  
[Non-integrated Platforms](#integratedadplatforms-non-integratedplatforms)
...
##### 1. Sign-in to your Bizible account at [apps.bizible.com.](http://apps.bizible.com) {#integratedadplatforms-sign-intoyourbizibleaccountatapps.bizible.com.}

##### 2. Go to My Account > Settings > Integrations > Connections. {#integratedadplatforms-gotomyaccount>settings>integrations>connections.}

![](assets/4-2.png)

##### 3. Select thePencil Iconnext to the Adwords Account that will be have Bizible auto-tagging enabled. {#integratedadplatforms-selectthepenciliconnexttotheadwordsaccountthatwillbehavebizibleauto-taggingenabled.}

![](assets/5-2.png)

##### 4. In the top right-hand corner, toggle theAutotagging switch toYes. At the bottom of the page, clickLearn More» to expand the text box and click Save. Auto-tagging setup is complete. {#integratedadplatforms-inthetopright-handcorner-toggletheautotaggingswitchtoyes.atthebottomofthepage-clicklearnmore»toexpandthetextboxandclicksave.auto-taggingsetupiscomplete.}
...
##### 1. Log-in to your Google AdWords Account. {#integratedadplatforms-log-intoyourgoogleadwordsaccount.}

##### 2. Go to your Campaigns view from the left-hand navigation bar {#integratedadplatforms-gotoyourcampaignsviewfromtheleft-handnavigationbar}

##### 3. **Navigate to "Settings", also in the left-hand nav bar {#integratedadplatforms-navigateto"settings"-alsointheleft-handnavbar}

##### 4. Toggle to the "Account Settings" view across the top {#integratedadplatforms-toggletothe"accountsettings"viewacrossthetop}

##### 5. Expand the "Tracking" section {#integratedadplatforms-expandthe"tracking"section}

##### 6. Paste one of the following strings of text in the tracking template to set the template’s value: {#integratedadplatforms-pasteoneofthefollowingstringsoftextinthetrackingtemplatetosetthetemplate’svalue-}
