...
[Enabling Touchpoints](#campaignsandcampaignmembers-enablingtouchpoints)  
[Campaign Sync Dates](#campaignsandcampaignmembers-campaignsyncdates)  
[Use Case for Touchpoint Start Date](#campaignsandcampaignmembers-usecasefortouchpointstartdate)  
[Use Case for Touchpoint End Date](#campaignsandcampaignmembers-usecasefortouchpointenddate)  
[Campaign Members](#campaignsandcampaignmembers-campaignmembers)  
[Bizible Touchpoint Status](#campaignsandcampaignmembers-bizibletouchpointstatus)  
[Bizible Touchpoint Date](#campaignsandcampaignmembers-bizibletouchpointdate)  
[Bulk Update Touchpoint Date](#campaignsandcampaignmembers-bulkupdatetouchpointdate)  
[Campaign Costs](#campaignsandcampaignmembers-campaigncosts)  
[Campaign Member Removal](#campaignsandcampaignmembers-campaignmemberremoval)
...
`This could be necessary if a list was uploaded days/weeks/months after an event actually occurred. There are ways to update all records at once, which is explained` [ `below`](#CampaignsandCampaignMembers-below) `.`
...
* `<li><span>The First Responded Date is automatically set as soon as the Status is changed to “Responded” and is a standard Salesforce field that cannot be changed</span></li>` 
* `Campaign Member Created Date`
...
>[!CAUTION]
>
>Keep in mind that this trigger does not track any campaign members that were removed in the past, so this only works moving forward. If you need to remove a large number of past campaign members' touchpoints, contact [ `[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#50232520203f22241032392a39323c357e333f3d).
