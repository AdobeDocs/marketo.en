...
##### Sync Bizible Touchpoints for new offline campaigns (2x/month) {#biziblemaintenance-syncbizibletouchpointsfornewofflinecampaigns(2x/month)}
...
##### Upload spend for all channels (1x/month) {#biziblemaintenance-uploadspendforallchannels(1x/month)}
...
##### Update list of domains to track (1x/month) {#biziblemaintenance-updatelistofdomainstotrack(1x/month)}

Bizible tracks all pages and subdomains where our Javascript is active, but only for domains that we know about. If you’ve recently debuted a new domain, expanded internationally, or changed your primary domain, send a message to [ `[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#dba8aeababb4a9af9bb9b2a1b2b9b7bef5b8b4b6) `to make sure we update your account accordingly.`

##### Review custom channel mapping for accuracy (1x/month) {#biziblemaintenance-reviewcustomchannelmappingforaccuracy(1x/month)}
...
##### Evaluate touchpoint suppression settings (1x/quarter) {#biziblemaintenance-evaluatetouchpointsuppressionsettings(1x/quarter)}
...
##### Review custom stage mapping for accuracy (1x/quarter) (if applicable) {#biziblemaintenance-reviewcustomstagemappingforaccuracy(1x/quarter)(ifapplicable)}
...
##### Compare Machine Learning Model to Custom Model weighting (1x/quarter) (if applicable) {#biziblemaintenance-comparemachinelearningmodeltocustommodelweighting(1x/quarter)(ifapplicable)}
