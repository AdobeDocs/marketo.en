...
##### 1. Open GTM and add the Bizible script on your website container. Be sure to select Custom HTML tag.  {#addingbiziblescriptviagoogletagmanager-opengtmandaddthebiziblescriptonyourwebsitecontainer.besuretoselectcustomhtmltag.}

##### 2. Use the Bizible script below and incorporate it in your container.  {#addingbiziblescriptviagoogletagmanager-usethebiziblescriptbelowandincorporateitinyourcontainer.}
...
a Firing Rule so that you can tell Google to load our snippet on *All Pages.* {#addingbiziblescriptviagoogletagmanager-click+addafiringrulesothatyoucantellgoogletoloadoursnippetonallpages.}

##### 4. Go to the Container Draft Overview section on the left. Click the button to create a new version of your container and publish the changes. {#addingbiziblescriptviagoogletagmanager-gotothecontainerdraftoverviewsectionontheleft.clickthebuttontocreateanewversionofyourcontainerandpublishthechanges.}
