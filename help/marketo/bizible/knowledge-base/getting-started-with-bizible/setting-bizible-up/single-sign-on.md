...
##### 1. Set up the Bizible Application in your Identity Provider. See external documentation listed below for walkthroughs. {#singlesignon-setupthebizibleapplicationinyouridentityprovider.seeexternaldocumentationlistedbelowforwalkthroughs.}

1. `<li><span>When prompted for the Single Sign On URL or Recipient URL or Destination URL, SAML Assertion Customer Service (ACS) URL, use</span><a href="https://apps.bizible.com/BizibleSAML2/ReceiveSSORequest" style="text-decoration: none;" class="external-link" rel="nofollow"><span>https://apps.bizible.com/BizibleSAML2/ReceiveSSORequest</span></a></li>` `<li><span>When prompted for the Audience Restriction URL or application-defined unique identifier, use</span><a href="https://biziblelpm/" style="text-decoration: none;" class="external-link" rel="nofollow"><span>https://BizibleLPM</span></a></li>`

##### 2. Switch to Custom SSO in the Bizible Application {#singlesignon-switchtocustomssointhebizibleapplication}

1. `<li><span>Once the Billing Group has been enabled for your Account, you can now navigate to Settings >> Security >> Authentication</span></li>` `<li><span>By default, your Login Type will be set to “CRM Users.”</span></li>` `<li><span>Switch the Login Type to “Custom SSO” to begin the configuration process.</span></li>`

##### 3. Fill in the connection settings for your Identity Provider configuration {#singlesignon-fillintheconnectionsettingsforyouridentityproviderconfiguration}
...
##### 4. Set the token expiration for your users in minutes. {#singlesignon-setthetokenexpirationforyourusersinminutes.}

1. `<li><span>Bizible allows a whole number from 1 to 1440 minutes. After a user’s session time has been exceeded, the user will get logged off once they navigate to a new page.</span></li>`

##### 5. Set up and map your User Attribute settings to the respective First Name, Last Name, and Email Address. {#singlesignon-setupandmapyouruserattributesettingstotherespectivefirstname-lastname-andemailaddress.}

1. `<li><span>By entering the SAML attributes, Bizible will be able to recognize your users by the information passed through.</span>  <ol>   <li>Email Attribute: Provide the attribute name that your Identity Provider uses for the user’s email address.</li>   <li><span>First Name Attribute: Provide the attribute name that your Identity Provider uses for the user’s first name.</span></li>   <li><span>Last Name Attribute: Provide the attribute name that your Identity Provider uses for the user’s last name.</span></li>  </ol></li>` `<li class="wysiwyg-text-align-left" style="text-align: left;"><span>Hint: If you test your SAML configuration now, we will parse out the Email, First Name, and Last Name attributes that you can use for this section.</span></li>`

![](assets/2.png)

##### 6. Set up and map your User Role settings to the respective roles or groups classified from your IdP. {#singlesignon-setupandmapyouruserrolesettingstotherespectiverolesorgroupsclassifiedfromyouridp.}
...
##### 7. Test the Single Sign On configuration {#singlesignon-testthesinglesignonconfiguration}
...
##### 8. Save your settings and direct your colleagues to use Single Sign On with your new custom Sign In URL. {#singlesignon-saveyoursettingsanddirectyourcolleaguestousesinglesignonwithyournewcustomsigninurl.}
...
##### 9. Try it out! {#singlesignon-tryitout!}
