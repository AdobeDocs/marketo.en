...
##### 1. Navigate to the Reports tab. {#hidingunnecessaryreporttypes-navigatetothereportstab.}

##### 2. Click the Create New Reportbutton at the top of the screen. {#hidingunnecessaryreporttypes-clickthecreatenewreportbuttonatthetopofthescreen.}

##### 3. Type in the word "Touchpoint" to populate all of the reports.   
{#hidingunnecessaryreporttypes-typeintheword"touchpoint"topopulateallofthereports.}

##### 4. Select the Select Report Types to Hide checkbox at the top left. {#hidingunnecessaryreporttypes-selecttheselectreporttypestohidecheckboxatthetopleft.}

##### 5. Click on the reports marked below with an orange X to make your report list look the same as the image below. {#hidingunnecessaryreporttypes-clickonthereportsmarkedbelowwithanorangextomakeyourreportlistlookthesameastheimagebelow.}
