...
##### 1. Always use an incognito browser or clear your cache between each form submission test AND use a different email address each time. {#addingbiziblescript-alwaysuseanincognitobrowserorclearyourcachebetweeneachformsubmissiontestanduseadifferentemailaddresseachtime.}
...
##### 2. Record the URL of the page you are submitting the form and the email used. {#addingbiziblescript-recordtheurlofthepageyouaresubmittingtheformandtheemailused.}

##### 3. Locate the record created in your CRM (Lead or Contact) for that form submission and verify that a touchpoint was appropriately created. {#addingbiziblescript-locatetherecordcreatedinyourcrm(leadorcontact)forthatformsubmissionandverifythatatouchpointwasappropriatelycreated.}
