...
[Custom Attribution Model](#customattributionmodelandsetup-customattributionmodel)  
[How to Set up Your Custom Attribution Model](#customattributionmodelandsetup-howtosetupyourcustomattributionmodel)  
[Touchpoint Positions](#customattributionmodelandsetup-touchpointpositions)  
[The Difference Between Funnel Stages and Custom Model Stages](#customattributionmodelandsetup-thedifferencebetweenfunnelstagesandcustommodelstages)
...
##### 1. Determine which stages you want to include in your custom model. {#customattributionmodelandsetup-determinewhichstagesyouwanttoincludeinyourcustommodel.}
...
If a custom field is being used in your custom model, Field History tracking MUST be enabled in the CRM. For instructions on how to enable field history tracking, [please click here.](http://docs.marketo.com/x/mQEgAQ)  

##### 2. Determine the attribution percentages for the custom model. {#customattributionmodelandsetup-determinetheattributionpercentagesforthecustommodel.}
