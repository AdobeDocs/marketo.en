...
##### Step 1: Create custom opportunity amount field in Dynamics {#step-create-custom-opportunity-amount-field-in-dynamics}

>[!NOTE]
>
>All Dynamics revenue fields have a base field and a regular field. Disregard the base field.

##### Step 2: Create a workflow that updates both the custom opportunity amount field created in step 1 and the Bizible Opportunity Amount field. {#step-create-a-workflow-that-updates-both-the-custom-opportunity-amount-field-created-in-step-and-the-bizible-opportunity-amount-field}
...
##### Amount Workflow Instructions: {#amount-workflow-instructions}
