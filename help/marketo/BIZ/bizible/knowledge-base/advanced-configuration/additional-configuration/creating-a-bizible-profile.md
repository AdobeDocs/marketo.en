...
1. Log-in to your Bizible Account and re-authorize the Salesforce connection with the new user:
   ...
   If you have any questions around creating a dedicated Bizible profile, please reach out to your success manager or [`[email protected]`](http://docs.marketo.com/cdn-cgi/l/email-protection#6e1d1b1e1e011c1a2e0c0714070c020b400d0103).
