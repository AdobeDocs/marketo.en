...
[Analytics Home Redesign](#analytics-home-redesign)  
[Marketo Mobile Engagement](#marketo-mobile-engagement)  
[LinkedIn Lead Accelerator Integration](#linkedin-lead-accelerator-integration)  
...
#### [Analytics Home Redesign](../../product-docs/reporting/basic-reporting/creating-reports/navigating-the-analytics-home-page.md) {#analytics-home-redesign}

>[!NOTE]
>
>This feature will be released Tuesday, April 28th.

The new [Analytics Home page](../../product-docs/reporting/basic-reporting/creating-reports/navigating-the-analytics-home-page.md) enables quick access for running ad-hoc reports across available report types.   ![](assets/image2015-4-20-11-3a18-3a8.png)
...
#### [Marketo Mobile Engagement](http://docs.marketo.com/display/docs/mobile+marketing) {#marketo-mobile-engagement}
...
#### [LinkedIn Lead Accelerator Integration](../../product-docs/demand-generation/social/social-functions/use-a-marketo-list-or-smart-list-as-a-linkedin-audience-segment.md) {#linkedin-lead-accelerator-integration}

Extend your lead nurture strategy to paid display and social ads. The [ad network integration](../../product-docs/demand-generation/ad-network-integrations/add-linkedin-matched-audiences-as-a-launchpoint-service.md) with LinkedIn Lead Accelerator allows you to securely create an audience segment within LinkedIn based on the members of any smart or static list. Members within a LinkedIn audience segment can then be nurtured with a sequence of relevant ads.
...
#### RTP - [Account-Based Marketing Analytics](http://docs.marketo.com/pages/viewpage.action?pageid=7511515) {#rtp-account-based-marketing-analytics}
