---
description: Current Release Notes Temp - Marketo Docs - Product Documentation
title: Current Release Notes Temp
hide: yes
hidefromtoc: yes
...
* **Used By Count Column for Design Studio Assets**: The Used By Count column for List Views in Design Studio highlights the number of assets that are being used. This is applicable for Snippets, Email Templates, Forms, and Landing Page Templates.
...
* **Trigger Tokens for New Activities**: New trigger tokens to support the new activities for Dynamic Chat.
