...
* **Bizible on Adobe Experience Cloud Interface**: Bizible's adoption of Adobe Experience Cloud Interface gives users new capabilities that will appear in the Bizible application header bar and include better access to support resources and application switching. The Experience Cloud Interface helps create a consistent experience between Bizible and other Adobe Experience Cloud applications.
