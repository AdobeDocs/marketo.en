...
Below you'll find all the features included in the January '26 release. Check your Adobe Marketo Engage edition for feature availability.
...
The following features fall under the standard release cycle and will start to be released on **January 30, 2026**, with a phased rollout of remaining features over the subsequent weeks. Release features and dates are subject to change. Please check next to each feature for its status.
