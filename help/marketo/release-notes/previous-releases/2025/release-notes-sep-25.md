...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>Released</td>
   <td><a href="/help/marketo/product-docs/email-marketing/email-designer/generate-content.md#set-up-permissions">Set up permissions</a></td>
  </tr>
  <tr>
   <td>&nbsp;</td>
   <td>&nbsp;</td>
...
* **Legacy Lead Activity Data Stream Deprecation**: By the end of June, 2026, users must migrate from the legacy Lead Activity Data Stream to the new Adobe I/O Lead Activity Data Stream (LADS). This deprecation affects only a handful of users who were onboarded to the Lead Activity Data Stream before it was integrated with Adobe I/O Events. If you are a newer data streams user or already manage the Lead Activity Data Stream via I/O Events, this has no impact on you. See [this article](https://developer.adobe.com/events/docs/guides/using/marketo/marketo-lead-activity-data-stream-migration){target="_blank"} for migration details.
