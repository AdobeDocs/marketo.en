...
* **Legacy Lead Activity Data Stream Migration**: This migration affects only a handful of users who were onboarded to the Lead Activity Data Stream before it was integrated with Adobe I/O Events. If you are a newer data streams user or already manage the Lead Activity Data Stream via I/O Events, this will have no impact on you. See [this article](https://developer.adobe.com/events/docs/guides/using/marketo/marketo-lead-activity-data-stream-migration){target="_blank"} for details.
